  ...
  <head>
    ...
    <!-- NProgress -->
    <link href="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/css/custom1.min.css" rel="stylesheet">
...
<div id="headercolor" class="col-lg-12 col-xs-12">
  <div class="row">
    ...
    <div class="col-lg-4 col-xs-12">
        <span style=" float:left; font-weight:bold; color: white; font-size:16px; padding-left:35px; padding-top: 5px"
            id="nomProjectName"></span>
    </div>
    <div class="col-lg-2 col-xs-12">
        <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist3" onchange="loadProjectPortfolio();">
            <option value="" selected >PORTEFEUILLE</option>
        </select>
    </div>
    <div class="col-lg-2 col-xs-12">
        <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist2" onchange="loadProjectPrograme();" disabled>
            <option value="" selected disabled>PROGRAMME</option>
        </select>
    </div>
    <div class="col-lg-2 col-xs-12">
        <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist4" onchange="FilterData();" disabled>
...
<div class="row">
    <div class="col-lg-2 col-xs-12" >
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/e-learning.png'
                ...
                <div class="card-body">
                    <p class="card-text" id="NombrePortefeuille" style="font-size: x-large; text-align: center;color: black;"></p>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                ...
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Nombre des Programme</h6>
                </div>
                <div class="card-body">
                    <p class="card-text" id="NombreProgramme" style="font-size: x-large; text-align: center;color: black;"></p>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                ...
                <div class="card-body">
                    <p class="card-text" id="NombreProjet" style="font-size: x-large; text-align: center;color: black;"></p>
                </div>
            </div>
        </div>
        
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/discount.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">% Achévement</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display:none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/yesterday.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Glissement projet</h6>
                </div>
                <div class="card-body">
                    <p class="card-text" id="GlissementProjet" style="font-size: x-large; text-align: center;color: black;">
                    </p>
                </div>
            </div>
        </div>
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display: none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/budget.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Coût projet</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display: none;">
            <div class="card-header">
                ...
                <div class="card-body">
                    <p class="card-text" id="CostConsomProject" style="font-size: x-large; text-align: center;color: black;"></p>
                </div>
            </div>
        </div>
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display: none;">
            <div class="card-header">
                ...
                <div class="card-body">
                    <p class="card-text" id="CostRestProject" style="font-size: x-large; text-align: center;color: black;"></p>
                </div>
            </div>
        </div>
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa; display: none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/analytics2.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Coût variance</h6>
                </div>
                <div class="card-body">

                    <p class="card-text" id="CostVariance" style="font-size: x-large; text-align: center;color: black;"></p>
                </div>
            </div>
        </div>
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/analytics.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Travail projet</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/risk.png' class='img-rounded'
                            alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Nombre risque</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa; ">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Project_Status/img/caution.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Nombre problème</h6>
                </div>
                <div class="card-body">

                    <p class="card-text" id="ProblemNumber" style="font-size: x-large; text-align: center;color: black;">
                    </p>
                </div>
    ...
    <div class="col-lg-10 col-xs-12" >
      <div id="mainSection" style="display : none;">
        <div class="row">
          <div class="col-lg-4 col-xs-12">
            <div class="dashbord dashbord-red">
                <div class="icon-section">
                    ...
                    <small style="font-size: large;">Nom du portefeuille</small>
                    <p id="ProtefeuilleProjet" style="font-size: 18px;"></p>
                </div>
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="dashbord shadowbox">
                <div class="icon-section">
                    <i class="fa fa-comments" aria-hidden="true"></i><br>
                    <small style="font-size: large;">Structure organisationnelle</small>
                    <p id="directionProjet" style="font-size: 18px;"></p>
                </div>
                <!--<div class="detail-section">
                    <a href="#">More Info </a>
                </div>-->
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="dashbord dashbord-skyblue">
                <div class="icon-section">
                    <i class="fa fa-comments" aria-hidden="true"></i><br>
                    <small style="font-size: large;">Nom de projet</small>
                    <p id="ProjetNameProjet" style="font-size: 18px;"></p>
                </div>
                <!--<div class="detail-section">
                    <a href="#">More Info </a>
                </div>-->
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="dashbord">
                <div class="icon-section">
                    ...
                    <small style="font-size: large;">Chef de projet</small>
                    <p id="chefProjet" style="font-size: 18px;"></p>
                </div>
                <!--<div class="detail-section">
                    <a href="#">More Info </a>
                  </div>-->
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="dashbord dashbord-orange">
                <div class="icon-section">
                    <i class="fa fa-calendar" aria-hidden="true"></i><br>
                    <small style="font-size: large;">Dernière date de modification</small>
                    <p id="dateDebutReelProjet" style="font-size: 18px;"></p>
                </div>
                <!--<div class="detail-section">
                    <a href="#">More Info </a>
                  </div>-->
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="dashbord dashbord-blue">
                <div class="icon-section">
                    <i class="fa fa-calendar" aria-hidden="true"></i><br>
                    <small style="font-size: large;">Dernière date de publication</small>
                    <p id="dateFinReelProjet" style="font-size: 18px;"></p>
                </div>
                <!--<div class="detail-section">
                    <a href="#">More Info </a>
                  </div>-->
                ...
                <div class="x_title">
                    ...
                    <div class="table-responsive">
                        <table id="tableaux" class="table table-striped  jambo_table bulk_action no-footer-border">
                            <thead>
                                <tr>
                                    <th class="column-title" style="text-align:center; background-color: #e59da2;">
                                        Description de projet</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <div id="descriptionProjet"></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div class="col-lg-6 col-xs-12">
            <div class="x_panel" style="width:100%; box-shadow: 0px 4px 8px 0px rgb(0 0 0 / 50%);border-radius: 5px;">
                <div class="x_title">
                    <h4 style="color: black"><b>Pourcentage d'achévement des phases</b></h4>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div id="myChart2Div">
        ...
        <div class="col-lg-6 col-xs-12">
            <div class="x_panel" style="width:100%; box-shadow: 0px 4px 8px 0px rgb(0 0 0 / 50%);border-radius: 5px;">
                <div class="x_title">
                    <h4 style="color: black"><b>Travail par ressource</b></h4>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
        ...
        <div class="row" id="jalonTab" style="display : none;">
            <div class="col-lg-4 col-xs-12">
    ...
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/jquery-3.3.1.slim.min.js"></script>
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/popper.min.js"></script>
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/bootstrap.min.js"></script>
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/LoadProjectProgram.js"></script>
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/MainFilterData.js"></script>
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/portfolio.js"></script>
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/chart.js@2.8.0.js"></script>
    <!--<script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/chartjs-plugin-labels.js"></script>-->
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/fastclick.js"></script>
    <!-- NProgress -->
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/nprogress.js"></script>
    <!-- iCheck -->
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/icheck.min.js"></script>

    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/echarts.min.js"></script>
    

  <script type="text/javascript" src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/yassin-test/js/moment-with-locales.js"></script>
...
var responsePortfolio = responsePortfolio ||[];
    var urlPortfolio = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=EnterpriseProjectTypeName";
    function loadAllPortfolio() {
                ...
                $.ajax({url:  urlPortfolio,          
                                        ...
                                        success: function(data) {  
                                          console.log(data.d.results[2])   
                                        responsePortfolio = responsePortfolio.concat(data.d.results);
                                            if (data.d.__next) {
                                                urlPortfolio = data.d.__next;
                                                loadAllPortfolio();
                                            }          
                              
                $.each(responsePortfolio, function(key, value) 
                {           
                        
                    var nomPortf = value.EnterpriseProjectTypeName;  
                           ...
                           $('#mylist3').append($('<option>',
                               {
                                ...
                                var projectsCount = $("#mylist3").children("option").length;
...
function calculGlissementGlobal(idProjetG,dateDebProjetG,dateFinProjetG,dateFinRefG){
   $.ajax({url:  urlDateBaseGlissement,          
            ...
            if (avgGliss<0 || isNaN(avgGliss)) {avgGliss=0;}
...
var urlAllProjectNumber = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,Programme,EnterpriseProjectTypeName,Types_de_Projet";
  ...
  $.ajax({url: urlAllProjectNumber,     
            ...
            $.each(responseAllNumberPr, function(key, value) 
            {
                 var nomProjet = value.ProjectName;
                          ...
                          if(projectType =='Page_Maitre' && nomProjet != null){
                         
                                nbre++;
                            
                          }
                            var structOrg=value.Programme;
                            console.log("value.program= "+value.programme);
                            console.log("structOrg= "+structOrg);
...
// console.log(arrPortefeuille.length,'projectsCoufffffffffffnt')
...
//********************************** travail, cout variance, cout projet**********************//
  ...
  var responseAllTicketsGlobal = responseAllTicketsGlobal || [];
  var urlDataLeftGlobal= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectCost,ProjectActualCost,ProjectCostVariance,ProjectWork,ProjectWorkVariance,ProjectPercentCompleted&$filter=Types_de_Projet%20eq%27Portefeuille%27";
function LoadAllDataLeftGlobal()
{
  ...
  var sommeCoutReel = 0;
            var sommeCoutRestant = 0
                ...
                $.ajax({url:urlDataLeftGlobal,                          
                    method: "GET",
                    dataType: "json",
                    headers: {Accept: "application/json;odata=verbose"},       
                    success: function(data) {     
                    responseAllTicketsGlobal = responseAllTicketsGlobal.concat(data.d.results);
                    if (data.d.__next) {
                      urlDataLeftGlobal = data.d.__next;
        ...
        $.each(responseAllTicketsGlobal, function(key, value) 
        {                 
