...
<head>
    ...
    <link href="/sites/pwa/_catalogs/masterpage/Dashboard/portefeuille/css/bootstrap.min.css" rel="stylesheet">
...
<div id="loader-wrapper" style="display:none">
            ...
            <div class="col-md-6 col-xs-12" style="padding: 10px 5px 10px 15px;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                                            <i class="fa fa-percent fa-2x"></i> Pourcentage achevé (pondéré) du programme:</h2></div>
                                        <!-- Demo info -->
                                ...
                                <div class="col-md-6 col-xs-12" style="padding: 10px 15px 10px 5px;">
                                    <div class="rounded-lg p-3 shadow" style=" background-color: #f18572;">
                                    <div class="row">
                                        <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
            ...
            <div class="row" id="row0">
                ...
                <div class="col-md-8 col-xs-12" style="padding-left: 5px;">
                    <div class="col-sm-12" style=" padding-left: 0px; padding-right: 0px;">
                        <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title" style="text-align: center;"><i class="fa fa-percent fa-2x"></i> Pourcentage achevé (pondéré) des projets
                                    </h3>
                                </div>
                                <div class="panel-body" style="padding: 0px 15px;">
                                    <div class="row">
                            ...
                            <div class="panel-heading" style="padding: 0px;">
                               <table class="table  table-hover table-striped" style=" margin-bottom: 0px; border-radius: 7px 7px 0px 0px;">
                                    <thead style="background-image: linear-gradient(225deg, #fceac5 20%, #f18572 80%);color: black; ">
                                            <tr>
                                                <th style="text-align:center;width: 50%;">Intitulé des projets</th>
    ...
    <script  src="/sites/pwa/_catalogs/masterpage/Dashboard/portefeuille/javascript/filterProgramme.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Dashboard/portefeuille/javascript/progsel1.js"></script>
