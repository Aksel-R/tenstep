...
<div id="loader-wrapper" style="display:none">
       ...
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                             <select 
                                ...
                                id="myList1" onchange="filterPortefeuille();">
            ...
            <div class="col-md-6 col-xs-12" style="padding: 10px 5px 10px 15px;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                                            <i class="fa fa-percent fa-2x"></i> Pourcentage achevé (pondéré) du portefeuille:</h2></div>
                                        <!-- Demo info -->
            ...
            <div class="row" id="row0">
                ...
                <div class="col-md-8 col-xs-12" style="padding-left: 5px;">
                    <div class="col-sm-12" style=" padding-left: 0px; padding-right: 0px;">
                        <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title" style="text-align: center;"><i class="fa fa-percent fa-2x"></i> Pourcentage achevé (pondéré) des programmes
                                    </h3>
                                </div>
                                <div class="panel-body" style="padding: 0px 15px;">
                                    <div class="row">
    ...
    <script  src="/sites/pwa/_catalogs/masterpage/Dashboard/portefeuille/javascript/filterPortefolio.js"></script>
