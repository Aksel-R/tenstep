  function valider(){
    ...
    '</div>';
        var ch1="arial";
        var ch2="MyriadPro-Bold";
        document.getElementById("row2").innerHTML ='<svg version="1.2" viewbox="0 0 1000 2158"  xmlns="http://www.w3.org/2000/svg">'+
                   ...
                   ' </path> </a>'+
                    ...
                    '</g>';
                     document.getElementById("row2").innerHTML +='<text transform="matrix(1 0 0 1 477.5 152.4998)" class="textArial"'+
                     
                     '" font-weight="bold" font-size="24" id="city-TUN105">بنزرت </text>'
                    '<text transform="matrix(1 0 0 1 614.5 198.4998)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN99">أريانة</text>'+
                    '<text transform="matrix(1 0 0 1 527.6016 259.2996)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN102">منوبة</text>'+
                    '<text transform="matrix(1 0 0 1 446.6016 314.4998)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN103">باجة</text>'+
                    '<text transform="matrix(1 0 0 1 240.6016 280.4998)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN106">جندوبة</text>'+
                    '<text transform="matrix(1 0 0 1 267.8994 462.4031)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN109">الكاف</text>'+
                    '<text transform="matrix(1 0 0 1 400.8994 453.408)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN115">سليانة</text>'+
                    '<text transform="matrix(1 0 0 1 556.25 408.408)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN120">زغوان</text>'+
                    '<text transform="matrix(1 0 0 1 770.0488 268.7107)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN107">نابل</text>'+
                    '<text transform="matrix(1 0 0 1 689.2998 232.7034)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN108">تونس</text>'+
                    '<text transform="matrix(1 0 0 1 623.9492 309.7107)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN104">بن عروس</text>'+
                    '<text transform="matrix(1 0 0 1 682.5 539.7107)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN116">سوسة</text>'+
                    '<text transform="matrix(1 0 0 1 733.0488 688.012)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN119">المهدية</text>'+
                    '<text transform="matrix(1 0 0 1 675.0488 840.012)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN114">صفاقس</text>'+
                    '<text transform="matrix(1 0 0 1 500.0488 641.4124)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN118">القيروان</text>'+
                    '<text transform="matrix(1 0 0 1 243.0488 738.4124)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN110">القصرين</text>'+
                    '<text transform="matrix(1 0 0 1 410.0488 833.1145)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN113">سيدي بوزيد</text>'+
                    '<text transform="matrix(1 0 0 1 269.0488 983.7083)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN112">قفصة</text>'+
                    '<text transform="matrix(1 0 0 1 539.7988 1140.3142)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN111">قابس</text>'+
                    '<text transform="matrix(1 0 0 1 722.999 1272.3142)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN96">مدنين</text>'+
                    '<text transform="matrix(1 0 0 1 297.999 1342.3142)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN97">قبلي</text>'+
                    '<text transform="matrix(1 0 0 1 536.0488 1625.3142)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN98">تاطاوين</text>'+
                    '<text transform="matrix(1 0 0 1 56.0488 1120.1052)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN101">توزر</text>'+
                    '<text transform="matrix(1 0 0 1 771.0488 602.012)" class="textArial"'+
                    
                    '" font-weight="bold" font-size="24" id="city-TUN117">المنستير</text>'+
                    '</svg>';
              
            
                    
                    document.getElementById("row3").innerHTML ='<div style="text-align: center; margin: 0; padding:0; margin-top: 50px;"> '+
                        '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 1104 125.891" >'+
                   '<g>'+
                   ...
                   '</g>';
                   document.getElementById("row3").innerHTML +='<text transform="matrix(1 0 0 1 70 46)" class="myriadPro"'+
                   
                   '" font-size="25" id="newscale1" style="text-align: center;"></text>'+
                   '<text transform="matrix(1 0 0 1 275.3794 46)" class="myriadPro"'+
                   
                   '" font-size="25" id="newscale2" style="text-align: center;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp الألوان</text>'+
                   '<text transform="matrix(1 0 0 1 502.7593 46)" class="myriadPro"'+
                   
                   '" font-size="25" id="newscale3" style="text-align: center;"></text>'+
                   '<text transform="matrix(1 0 0 1 720.1387 46)" class="myriadPro"'+
                   
                   '" font-size="25" id="newscale4" style="text-align: center;"></text>'+
                   '<text transform="matrix(1 0 0 1 933.5186 46)" class="myriadPro"'+
                   
                   '" font-size="25" id="newscale5" style="text-align: center;"></text>'+
                   '</svg>';
                document.getElementById("row4").innerHTML ='<table class="table table-bordered table-striped table-hover table-sticky"style="margin-top: 10px;" id="tableau" >'+
                    '<tr>'+
                      '<thead class="thead" style="background-image: linear-gradient(225deg, #e9967a 20%, #ed5f49 80%);color: black;">'+
                        '<th class="text-center" style="text-align:center;width: 10%;"> التكلفة الحالية </th>'+
