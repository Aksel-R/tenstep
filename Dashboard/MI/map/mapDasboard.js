...
<head>
  ...
  <link href="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/css/style.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/css/achevement.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/css/w3.css" rel="stylesheet">
...
<body>
  ...
  <div id="headercolor">
    <div class="row">
      ...
      <div class="col-md-3">
        <input class="form-check-rad-input" type="radio" name="flexRadioDefaultRad" id="flexRadioDefault1" checked/>
        <label class="form-check-rad-label" for="flexRadioDefault1" style="color: white;padding-top: 2%;"> التكلفة الحالية </label>
    </div>
    <div class="col-md-3">
      <input class="form-check-rad-input" type="radio" name="flexRadioDefaultRad" id="flexRadioDefault2" />
        <label class="form-check-rad-label" for="flexRadioDefault1" style="color: white;padding-top: 2%;"> التكاليف المقررة </label>
    </div>
    
    <div class="col-md-3">
        <input class="form-check-rad-input" type="radio" name="flexRadioDefaultRad" id="flexRadioDefault3" />
        <label class="form-check-rad-label" for="flexRadioDefault1" style="color: white;padding-top: 2%;"> الميزانية السنوية </label>
    </div>
    <div class="col-md-3">
      <button type="button" class="btn btn-primary"  id="valider1">مصادقة</button>
    </div>
  ...
  <div id="headercolor">
    <div class="row" id="row1">
      ...
      <div class="col-md-4">
      <select class="form-control" style="color:black; font-weight:bold;" id="objectif" onchange="disabled2();filter();">
              <option value="">فئة المشاريع</option>
      </select>
    </div>
    <div class="col-md-4">
      <select class="form-control" style="color:black; font-weight:bold;" id="mylist1"
                onchange="disabled1();selectMyList1();filter();">
...
<div id="headercolor">
    <div class="row" id="row1">
      ...
      <div class="col-md-6">
      <select class="form-control" style="color:black; font-weight:bold;" id="mylist3" onchange="disabled3();filter();">
              <option value="">وضع المشروع</option>
      </select>
    </div>
    <div class="col-md-6">
      <select class="form-control" style="color:black; font-weight:bold;" id="mylist4"
                onchange="disabled4();filter();">
                <option value="">طبيعة المشروع</option>
            </select>
    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="mapdiv" id="row2">
                    ...
                    <g id="textBgColor" style="display:none;">
                    	<rect x="464.298" y="128.5" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="159.65" height="28.3"/>
                    	<rect x="607.853" y="173.5" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="149.502" height="28.3"/>
                    	<rect x="729.224" y="664.299" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="155.221" height="28.3"/>
                    	<rect x="289.913" y="1318.014" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="156.688" height="28.302"/>
                    	<rect x="538.9" y="1117.387" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="150.4" height="28.301"/>
                    	<rect x="263.08" y="959.895" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="151.365" height="28.302"/>
                    	<rect x="670.443" y="816.901" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="133.857" height="28.3"/>
                    	<rect x="680.425" y="515" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="143.074" height="28.3"/>
                    	<rect x="443.275" y="291.929" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="114.324" height="28.298"/>
                    	<rect x="259.545" y="438.7" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="115.9" height="28.3"/>
                    	<rect x="677.111" y="207" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="157.903" height="28.3"/>
                    	<rect x="760.263" y="243.411" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="149.502" height="28.3"/>
                    	<rect x="768.048" y="578.131" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="178.525" height="28.3"/>
                    	<rect x="391.203" y="429.2" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="163.597" height="28.3"/>
                    	<rect x="615.47" y="285.2" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="197.975" height="28.3"/>
                    	<rect x="550.328" y="384.401" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="192.432" height="28.3"/>
                    	<rect x="236.781" y="714.112" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="199.019" height="28.3"/>
                    	<rect x="403.773" y="809.901" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="198.605" height="28.3"/>
                    	<rect x="234.836" y="254.35" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="192.433" height="28.3"/>
                    	<rect x="719.74" y="1248.014" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="173.705" height="28.302"/>
                    	<rect x="532.652" y="1600.014" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="196.652" height="28.302"/>
                    	<rect x="48.773" y="1096.601" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="168.633" height="28.302"/>
                    	<rect x="496.283" y="616.7" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="192.432" height="28.3"/>
                    	<rect x="522.474" y="236.15" opacity="0.4" fill="#FFFFFF" enable-background="new    " width="192.434" height="28.3"/>
                    </g>
                     <text transform="matrix(1 0 0 1 477.5 152.4998)" class="textArial" font-weight="bold" font-size="24" id="city-TUN105">بنزرت </text>
                    <text transform="matrix(1 0 0 1 614.5 198.4998)" class="textArial" font-weight="bold" font-size="24" id="city-TUN99">أريانة</text>
                    <text transform="matrix(1 0 0 1 527.6016 259.2996)" class="textArial" font-weight="bold" font-size="24" id="city-TUN102">منوبة</text>
                    <text transform="matrix(1 0 0 1 446.6016 314.4998)" class="textArial" font-weight="bold" font-size="24" id="city-TUN103">باجة</text>
                    <text transform="matrix(1 0 0 1 240.6016 280.4998)" class="textArial" font-weight="bold" font-size="24" id="city-TUN106">جندوبة</text>
                    <text transform="matrix(1 0 0 1 267.8994 462.4031)" class="textArial" font-weight="bold" font-size="24" id="city-TUN109">الكاف</text>
                    <text transform="matrix(1 0 0 1 400.8994 453.408)" class="textArial" font-weight="bold" font-size="24" id="city-TUN115">سليانة</text>
                    <text transform="matrix(1 0 0 1 556.25 408.408)" class="textArial" font-weight="bold" font-size="24" id="city-TUN120">زغوان</text>
                    <text transform="matrix(1 0 0 1 770.0488 268.7107)" class="textArial" font-weight="bold" font-size="24" id="city-TUN107">نابل</text>
                    <text transform="matrix(1 0 0 1 689.2998 232.7034)" class="textArial" font-weight="bold" font-size="24" id="city-TUN108">تونس</text>
                    <text transform="matrix(1 0 0 1 623.9492 309.7107)" class="textArial" font-weight="bold" font-size="24" id="city-TUN104">بن عروس</text>
                    <text transform="matrix(1 0 0 1 682.5 539.7107)" class="textArial" font-weight="bold" font-size="24" id="city-TUN116">سوسة
                    </text>
                    <text transform="matrix(1 0 0 1 733.0488 688.012)" class="textArial" font-weight="bold" font-size="24" id="city-TUN119">المهدية</text>
                    <text transform="matrix(1 0 0 1 675.0488 840.012)" class="textArial" font-weight="bold" font-size="24" id="city-TUN114">صفاقس</text>
                    <text transform="matrix(1 0 0 1 500.0488 641.4124)" class="textArial" font-weight="bold" font-size="24" id="city-TUN118">القيروان</text>
                    <text transform="matrix(1 0 0 1 243.0488 738.4124)" class="textArial" font-weight="bold" font-size="24" id="city-TUN110">القصرين</text>
                    <text transform="matrix(1 0 0 1 410.0488 833.1145)" class="textArial" font-weight="bold" font-size="24" id="city-TUN113">سيدي بوزيد</text>
                    <text transform="matrix(1 0 0 1 269.0488 983.7083)" class="textArial" font-weight="bold" font-size="24" id="city-TUN112">قفصة</text>
                    <text transform="matrix(1 0 0 1 539.7988 1140.3142)" class="textArial" font-weight="bold" font-size="24" id="city-TUN111">قابس</text>
                    <text transform="matrix(1 0 0 1 722.999 1272.3142)" class="textArial" font-weight="bold" font-size="24" id="city-TUN96">مدنين</text>
                    <text transform="matrix(1 0 0 1 297.999 1342.3142)" class="textArial" font-weight="bold" font-size="24" id="city-TUN97">قبلي</text>
                    <text transform="matrix(1 0 0 1 536.0488 1625.3142)" class="textArial" font-weight="bold" font-size="24" id="city-TUN98">تاطاوين</text>
                    <text transform="matrix(1 0 0 1 56.0488 1120.1052)" class="textArial" font-weight="bold" font-size="24" id="city-TUN101">توزر</text>
                    <text transform="matrix(1 0 0 1 771.0488 602.012)" class="textArial" font-weight="bold" font-size="24" id="city-TUN117">المنستير</text>
                    </svg>
              </div>
            </div>
            <div class="col">
                <div class="text-right mt-5">
                    ...
                    <div style="text-align: center; margin: 0; padding:0; margin-top: 50px;" id="row3"> 
						<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" 
						viewBox="0 0 1104 125.891" >
				   <g>
					   <path fill-rule="evenodd" clip-rule="evenodd" fill="#A6A7A9" d="M222,126.891c-72.261,0-144.521-0.037-216.782,0.104
						   c-3.68,0.008-4.37-0.842-4.317-4.379c0.23-15.48,0.23-30.969,0-46.45c-0.052-3.537,0.638-4.387,4.317-4.379
						   C77.479,71.926,149.739,71.89,222,71.89C222,90.224,222,108.557,222,126.891z"/>
					   <path fill-rule="evenodd" clip-rule="evenodd" fill="#94C74E" d="M663,71.89c73.667,0,147.333,0,221,0c0,18.333,0,36.667,0,55
						   c-73.667,0-147.333,0-221,0C663,108.557,663,90.224,663,71.89z"/>
					   <path fill-rule="evenodd" clip-rule="evenodd" fill="#1B8B43" d="M884,126.891c0-18.334,0-36.667,0-55
						   c72.333,0,144.667,0.031,217-0.096c3.424-0.006,4.154,0.664,4.104,4.098c-0.235,15.663-0.235,31.334,0,46.997
						   c0.051,3.434-0.68,4.104-4.104,4.098C1028.667,126.859,956.333,126.891,884,126.891z"/>
					   <path fill-rule="evenodd" clip-rule="evenodd" fill="#F1DA66" d="M663,71.89c0,18.333,0,36.667,0,55c-73,0-146,0-219,0
						   c-0.321-0.303-0.642-0.605-0.963-0.907c-1.418-1.923-0.929-4.154-0.938-6.272c-0.062-15.939-0.072-31.88-0.1-47.821
						   C515.667,71.89,589.333,71.89,663,71.89z"/>
					   <path fill-rule="evenodd" clip-rule="evenodd" fill="#F3B084" d="M442,71.89c0.027,15.94,0.038,31.881,0.1,47.821
						   c0.009,2.118-0.48,4.35,0.938,6.271c-0.032,0.301-0.045,0.604-0.037,0.908c-73.667,0-147.333,0-221,0c0-18.334,0-36.667,0-55
						   C295.333,71.89,368.667,71.89,442,71.89z"/>
				   </g>
				   <text transform="matrix(1 0 0 1 70 46)" class="myriadPro" font-size="25" id="newscale1" style="text-align: center;"></text>
				   <text transform="matrix(1 0 0 1 275.3794 46)" class="myriadPro" font-size="25" id="newscale2" style="text-align: center;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp ألوان المقياس</text>
				   <text transform="matrix(1 0 0 1 502.7593 46)" class="myriadPro" font-size="25" id="newscale3" style="text-align: center;"></text>
				   <text transform="matrix(1 0 0 1 720.1387 46)" class="myriadPro" font-size="25" id="newscale4" style="text-align: center;"></text>
				   <text transform="matrix(1 0 0 1 933.5186 46)" class="myriadPro" font-size="25" id="newscale5" style="text-align: center;"></text>
				   </svg>
					</div>
                </div>
                <div class="row table-responsive table-height" id="row4">
                  <table class="table table-bordered table-striped table-hover table-sticky"style="margin-top: 10px;" id="tableau" >
                    <tr>
                      <thead class="thead" style="background-image: linear-gradient(225deg, #e9967a 20%, #ed5f49 80%);color: black;">
                        <th class="text-center" style="text-align:center;width: 10%;" id="thName"> التكلفة الحالية </th>
                        <th class="text-center" style="text-align:center;width: 10%;"> الولاية </th>
                      </thead>
                      <tbody></tbody>
                    </tr>
                  </table>
...
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/filter.js"></script>
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/selectMyList1.js"></script>
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/valider.js"></script>
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/disabled1.js"></script>
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/disabled2.js"></script>
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/disabled3.js"></script>
<script src="/sites/pwa/_catalogs/masterpage/Dashboard/MapTN/javascript/disabled4.js"></script>
...
document.getElementById("valider1").onclick=valider;
jQuery(document).ready(function() {
    jQuery('#overlay').fadeOut(10000);
        ...
        LoadSelDeb();
            ...
            var responseSelCatvSel1 = responseSelCatvSel1 || [];
            var urlSelCatvSel1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Pai_2022_Global')/items?$select=categorie_Proj_ar&$orderby=categorie_Proj_ar";
            
            function LoadSelCatvSel1() {
                $.ajax({
                    url: urlSelCatvSel1,
                    ...
                    headers: { Accept: "application/json;odata=verbose" },
                    success: function (data) {
                        responseSelCatvSel1 = responseSelCatvSel1.concat(data.d.results);
                        if (data.d.__next) {
                            urlSelCatvSel1 = data.d.__next;
                            LoadSelCatvSel1();
                        }else if (!data.d.__next) {
                            $.each(responseSelCatvSel1, function (key, value) {


                                var nomGouv = value.categorie_Proj_ar;
            ...
            LoadSelCatvSel1();
            var responseSelNatvSel1 = responseSelNatvSel1 || [];
            var urlSelNatvSel1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Pai_2022_Global')/items?$select=nature_Proj_ar&$orderby=nature_Proj_ar";
            
            function LoadSelNatvSel1() {
                $.ajax({
                    url: urlSelNatvSel1,
                    ...
                    headers: { Accept: "application/json;odata=verbose" },
                    success: function (data) {
                        responseSelNatvSel1 = responseSelNatvSel1.concat(data.d.results);
                        if (data.d.__next) {
                            urlSelNatvSel1 = data.d.__next;
                            LoadSelNatvSel1();
                        }else if (!data.d.__next) {
                            $.each(responseSelNatvSel1, function (key, value) {
            ...
            LoadSelNatvSel1();
            var responseSelStatvSel1 = responseSelStatvSel1 || [];
            var urlSelStatvSel1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Pai_2022_Global')/items?$select=status_Exec_ar&$orderby=status_Exec_ar";
            
            function LoadSelStatvSel1() {
                $.ajax({
                    url: urlSelStatvSel1,
                    ...
                    headers: { Accept: "application/json;odata=verbose" },
                    success: function (data) {
                        responseSelStatvSel1 = responseSelStatvSel1.concat(data.d.results);
                        if (data.d.__next) {
                            urlSelStatvSel1 = data.d.__next;
                            LoadSelStatvSel1();
                        }else if (!data.d.__next) {
                            $.each(responseSelStatvSel1, function (key, value) {
