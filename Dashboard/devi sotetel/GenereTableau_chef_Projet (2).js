    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $.each(dataResults, function (key, value) {
          ...
          var tr;
          tr = $("<tr class='rows'/>");
          tr.append("<td style='width:30px;'>" + UniqueAtt + "</td>");
...
var commandeOuverte = TypeCommande;
          ...
          if ((commandeOuverte =="Commande Standard")&&(codearticle != null) &&(quantites >0)) {
            ...
            tr = $("<tr class='rowArticles3'/>");
              ...
              tr.append("<td style='text-align:center;'><input id='quantiteAtt' name='kp1_inputnumber' min='0.000'  step='0.001' max='" + quantites + "' class='refresh_pricesAtt row_priceAtt' value='" + quantiteResult + "' type='number' style='width: 80px; height: 30px; text-align:center; border:none;'/></td>");
              ...
              tr.append("<td><input type='checkbox' name='showHide' id='checkboxId' class='data-checkAttachement'/></td>");
...
var ResponseUrlConsultingAtt = ResponseUrlConsultingAtt || [];
  ...
  $('#BoutonValiderAttachement').click(function () {
    /*$(".aSupprimerTableau input:checkbox").each(function(){
                  if (this.checked == false) {
                       $(this).parent().parent().remove();
                  }
                  return true;  
