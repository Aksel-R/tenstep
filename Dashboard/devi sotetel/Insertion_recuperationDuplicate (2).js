  ...
  function LoadId11(urlAllProjet1)
  {
        ...
        {                 
                ...
                console.log("idDevis " + idDevis);
                    ...
                    /*else
                    {
                      var IdProjet = idDevis;
                      //p1.push(parseFloat(IdProjet)+1);
                      p1.push(parseFloat(IdProjet)+2);
                    }*/
...
function CodeOracle() {
              var ProjUid = document.getElementById("nomprojet").value;
               //var ProjUid = $('#nomprojet').find(":selected").val();
               var data =  $.ajax({ url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects(guid'"+ProjectUID+"')",
...
/*
  var urlAllProjet = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Id_Devis')/items";

  var genereAllProject = genereAllProject || [];
  var p = [];
  function LoadId()
  {
                $.ajax({url:urlAllProjet,                           
                    method: "GET",
                    dataType: "json",
                    headers: {Accept: "application/json;odata=verbose"},       
                    success: function(data) {     
  ...
  }  _spBodyOnLoadFunctionNames.push("LoadId");
setTimeout(LoadId,10000);
*/
...
/*var IdProjetLoaded = "";
  var urlAllProjet1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Id_Devis')/items";

  var genereAllProject1 = genereAllProject1 || [];
  
  function LoadId1(projectlink)
  {
                $.ajax({url:urlAllProjet1,                           
                    method: "GET",
                    dataType: "json",
...
var p1 = [];
        ...
        {                 
                ...
                var nomprojectforid = value.Title; 
                    ...
                    if(nomprojectforid === nomdeprojet)
                    {
                      var IdProjet = idDevis;
        ...
        Array.prototype.max = function() {
                ...
                IdProjetLoaded = (p1.max())+1; 
                
                $('#pcode1').val(p1.max());  
      }   
  });
  }  _spBodyOnLoadFunctionNames.push("LoadId1");
//setTimeout(LoadId1,10000);*/
...
if (typeRes=="Articles") {
                  ...
                  trSuiv.append("<td><input id='quantite' min='0.000'  step='0.001'  class='refresh_prices row_price' value='"+quantpr+"' type='number' style='width: 50px; height: 30px; text-align:center;'/></td>");
