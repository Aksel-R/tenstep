...
<div id="Modaldelete" class="modal">
  ...
  <div class="modal-content" style="width: fit-content;">
    <h1>
    Valider la suppression de devis!
    </h1>
    <div class="col-lg-6" id="divValiderSuppDev">
      
    </div>
    <div class="col-lg-6">
      <button type="button" id="acceptdelete" class="btn btn-default" data-dismiss="modal">  
        Annuler
      </button>
    </div>
        ...
        $.each(PaginationUrl, function (key, value) {
          ...
          if (nomprojet != null) {
            ...
            tr = $("<tr class='rowClasse'/>");
                tr.append("<td><button data-toggle='tooltip' title='Supprimer' id='supprDevis' class='delete ' value='" + IdentifiantListe + "' onclick='ApprouvSupprimerDevis()' style='color:white; background-color:red; border-radius: 5px;' ><i class='fa fa-trash-o fa-lg'></i> </button></td>");
...
function ApprouvSupprimerDevis(){
