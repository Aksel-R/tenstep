                ...
                <table class="table table-clear" style="color: black;">
                    <tbody >
                        ...
                        <tr>
                          ...
                          <tr>
                <td class="left">
                <button id="chk" type="submit" onclick="verifierSiteOp();" class="confirmerDevis btn btn-primary"  name="chk" >Valider Les Articles</button>
                </td>
                <td class="right">
...
$(document).ready(function(){
            ...
            $("#tableau .rows input:number").each(function(){
                $quantite = $(this).closest('tr').find('#quantite').val();
                //$checkboxed = $(this).closest('tr').find('#checkboxId').attr("disabled", true);

                $("#quantite").keyup(function() {
                    console.log("Ecrire")
                    $(this).closest('tr').find('#checkboxId').attr("disabled", false);
...
/*$(document).ready(function(){
    $('.confirmerDevis').click(function(){
            $("#tableau .rows").each(function(){
                $quantite = $(this).closest('tr').find('#quantite').val();
                console.log($quantite);
                if ($quantite != 0) {
                    console.log("différence 0");
                     $(this).parent().parent().remove();
                      //$(this).attr("disabled", true);
...
$('#chk').click(function(){
  $("#tableau input:checkbox").each(function(){
    ...
    /*$('.row_price').setAttribute('readonly', true);*/
...
function onSuccess(data, request) {
    ...
    var nom = document.getElementById('chefprojet').innerHTML;
        ...
        {
           //alert("Vous n'avez pas le droit de crée un devis");
           $('#modal-dialog').hide();   
           $('.confirmerDevis').hide(); 
           $('#tableau').hide();
           $('#rejete').show();
