      ...
      <div id="headercolor">
          ...
          <div>
            ...
            <select class="mdb-select md-form"  style="color:black; font-weight:bold;" id="mylist4"
                onchange="loadListsByExercice();MainFilter();">
        ...
        <!-- page content -->
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="panel panel-primary">
                  <div class="panel-heading" >
                    <h3 id="txtcat" class="panel-title">TRAVAIL</h3>
                    
                  </div>
                  <div class="panel-body" style="padding: 0px 15px;" id="container1">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="panel panel-primary">
                  <div class="panel-heading" >
                    <h3 id="txtcat" class="panel-title">TRAVAIL ACTUEL / TRAVAIL RESTANT</h3>
                    
                  </div>
                  
                  <div class="panel-body" style="padding: 0px 15px;" id="container2">
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading" style="min-height: 40px;">
                    <div class="col-md-9 col-sm-9 col-xs-9">
                      <h3 id="txtcat" class="panel-title">TRAVAIL PAR RESSOURCE</h3>
                    </div>
                  ...
                  <div>
                    ...
                    <h2 id="affichagesEchart" style="display:none">No Data Avaialable</h3>
                  </div>
                  </div>
            ...
            <div class="col-md-12 col-sm-10 col-xs-12">
                <div class="panel panel-primary"style="box-shadow: 0px 4px 8px 0px rgb(0 0 0 / 50%);">
                  <div class="panel-heading" >
                    <h3 id="txtcat" class="panel-title">AFFECTATIONS</h3>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="panel-body" id="affectationsTables" style="padding: 0px 15px;">
...
<script type="text/javascript" src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/momentjs.com_downloads_moment-with-locales.js"></script>
    <!-- jQuery -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.3.0/Chart.js"></script>
   ...
   <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/chart.js@2.8.0.js"></script> 
...
<script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/selectExercice.js"></script>
<script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/chart.js@2.8.0.js"></script>
