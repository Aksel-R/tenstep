function MainFilter(){
	...
	var exerciseSel=document.getElementById("mylist4").value;
  	...
  	if (exerciseSel!="") {
  		...
  		chaineFilterProject+=" and ProjectStartDate%20ge%20datetime%27"+exerciseSel+"T00:00:00.000%27 and ProjectStartDate%20lt%20datetime%27"+nextYear+"T00:00:00.000%27"
  	}
	if (portfolioSel!="") {
	...
	var resNameSel1=document.getElementById("mylist3").value;
	var resNameSel=resNameSel1.replace('&', '%26');
	if (resNameSel!="") {
                ...
                success: function (data) {
                    ...
                    if (!data.d.__next){
	                    ...
	                    $.each(responseProjFilter, function (key, value) {
	                        ...
	                        var variableChart="";
	                        var exerciceSel1=document.getElementById("mylist4").value;
							...
							if (exerciceSel1!=""){
	                        	variableChart=portefeuille;
	                        	chaineTravail='Travail par portefeuille (Jour)';
	                        }
	                        if (portfolioSel1!=""){
	                        	variableChart=progg;
		                ...
		                success: function (data) {
		                    ...
		                    if (responseAssigFilter.length>0) {
		                    	if (!data.d.__next){
		                    		...
		                    		'<table id="'+idTableu+'" class="table table-striped jambo_table table-bordered" style="height: 200px;width: 90%;margin-left: 5%;margin-right: 5%;">'+
		                            '<tbody>'+
		                            '</tbody>'+
		                          	'</table>'+
		                    		'</div>';
	                    			...
	                    			trHead2.append("<th tyle='width: 25%;'>Nom Ressource</th>");
	                    			trHead2.append("<th tyle='width: 10%;'>Début Assignement </th>");
	                    			trHead2.append("<th tyle='width: 10%;'>Fin Assignement </th>");
	                    			trHead2.append("<th tyle='width: 10%;'> %Achévement Assignement</th>");
	                    			trHead2.append("<th tyle='width: 10%;'> Travail Assignement </th>");
