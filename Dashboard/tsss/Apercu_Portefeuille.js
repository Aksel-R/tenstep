    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
            ...
            <div class="col-md-3 col-xs-12">
                <select style="float: right; width: 100%; background-color: white; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList1" onchange="selectMyList1111();filterPortefeuille();">
                                <option value="" selected disabled>Portefeuille</option>

                            </select>
            </div>
            <div class="col-md-3 col-xs-12">
                            <select disabled="" style="float: right; width: 100%; background-color: white; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList3" onchange="filterPortefeuille();">
        ...
        <script src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/Chart.min.js"></script>
         <script  src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/filterApercuPortefolio.js"></script>
