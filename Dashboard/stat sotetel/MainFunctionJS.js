...
function loadMainPage(){
  console.log("maiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiin");
...
//Table Project 
var LinkClient = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,Direction,ProjectCost,ProjectFinishDate,ProjectStartDate,Client,ProjectOwnerName,ProjectPercentCompleted,ProjectName,ProjectActualCost,Montant";
...
function LoadTableProjectsClient() {
        ...
        var coutAct=parseFloat((projCostes*projetTermine)/100).toFixed(3);
                    var tr;
                    tr = $("<tr class='even pointer'>");
                        tr.append("<td style='width: 12%; text-align: left;'>" +client+"</td>"); //1
                        tr.append("<td style='width: 12%; text-align: left;'>" + nomProjet +" </td>"); //11 //11
                        tr.append("<td style='width: 3%; text-align: left;'><a href='https://sotetel.spps.tn/pwa/project%20detail%20pages/schedule.aspx?projuid="+identifiantProjet+"&ret=0' id='redirectLink' target='_blank'><img src='/PWA/_catalogs/masterpage/Dashboard/img/link.png' class='img-rounded' alt='Cinque Terre' width='20px' height='20px'></a></td>");

                        tr.append("<td style='width: 9%'>" + pOwner +" </td>"); //12
                        tr.append("<td style='width: 10%'>" + conToMill(projCostes) +" </td>");
                        tr.append("<td style='width: 10%'>" + conToMill(coutAct) +" </td>");  //13
                        tr.append("<td style='width: 10%'>" + projStartDate +"</td>"); //14
                        tr.append("<td style='width: 10%'>" + projfinishdate +" </td>"); //15
                        tr.append('<td style="text-align:center;width: 10%">'+projetTermine+'%<progress id="" max="100" value="'+projetTermine+'" style="width: 100%"></progress></td>');
