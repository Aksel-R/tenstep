...
<div id="headercolor">
    <div>
        <small class="smallRisks">
            <h2 id="titreProjets">Suivi des projets  </h2> 
            <br>
            <h2 id="titreProjets">  </h2> 
        </small>
    </div>
    <div id="nomprojet1" style="display:none;">Project Name</div>
    <div>
    <select class="form-item__element form-item__element--select" style="color:black; font-weight:bold;"
            id="Filtrage" onchange="displayFilter();">
            <option value="exercice" selected>Exercice</option>
            <option value="filtre">Intervale de temps</option>
        </select>
        </div>
        <br>
    ...
    <div id="filtretemps" style="display: none">
    <br>
...
<div class="preload" id="preload">
  <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/spinner.gif">
</div> 
...
<div class="menu">
    <ul>
        ...
        <div class="card" style="margin-bottom: 1rem;margin-top: 10px;min-height: 70px;;margin-left: 10px;">
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                    <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/Nombre-projet.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Nombre de projet</h5>
        ...
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                   <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/Cout-des-projets.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Côut des projets</h5>
        ...
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                   <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/Ecart-de-cout.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Écart de coût</h5>
        ...
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                    <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/Travail-de-projet.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Travail de projet</h5>
        ...
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                   <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/ecart-travail.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Écart de travail</h5>
        ...
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                    <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/risk.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Nombre de Risque</h5>
        ...
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-sm-5" style="padding-right: 0px;padding-left: 2%;">
                    <img src="/PWA/_catalogs/masterpage/Suivi_projet/img/Nombre-probleme.png" class="img-rounded" alt="Cinque Terre" width="70%" height="80%" data-themekey="#" style="margin-top: 5%;">
                </div>
                <div class="col-sm-7" style="padding-left: 0px;padding-right: 0px;">
                    <div class="card-body" style="padding: 1em 0em">
                        <h5 class="card-title" style="font-weight: bold;font-size: 150%;">Nombre de problème</h5>
...
<div class="col-sm-10" style="max-width: 80%;">
                    ...
                    <div class="col-sm-12" style="padding-right: 0px; padding-left: 0px;">
                        <div class="card-box">
                            ...
                            <table class="table" style="border-radius:15px 15px 0px 0px;margin-bottom: 0px;" id="myTable1">
                                    <thead>
                                    <tr>
                                        <th style="width: 12%; text-align: left;">Client</th>
                                        <th style="width: 12%; text-align: left;">Projet</th>
                                        <th style="width: 4%; text-align: left;"></th>
                                        <th style="width: 10.6%;text-align: left;">Chef de projet</th>
                                        <th style="width: 9.6%; padding-left: 0px;text-align: left;">C.A planifié</th>
                                        <th style="width: 9.6%; padding-left: 0px;text-align: center;">C.A Réalisé</th>
                                        <th style="width: 10%; padding-left: 0px;text-align: center;">Date début</th>
                                        <th style="width: 10%; padding-left: 0px;text-align: center;">Date fin</th>
                                        <th style="width: 10%;text-align: left;">% Achevé total</th>
                                        <th style="display:none;">Direction</th>
                                        <th style="" id="thAchPer">% Achevé Periode</th>
                                        <th ></th>
                                    </tr>
                                    </thead>
                                </table>
 ...
 <script src="/PWA/_catalogs/masterpage/Suivi_projet/javascript/AffichageFiltre.js"></script>
