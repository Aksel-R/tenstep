...
<div id="loader-wrapper" style="display:none">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-4 col-xs-12" style="padding: 10px 5px 10px 15px;">
             ...
             <div class="col-md-4 col-xs-12" style="padding:10px 15px 10px 5px">
                ...
                <div class="row">
                    <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                        <i class="fa fa-calculator fa-2x"></i>Phase à date du projet</h2></div>
                    <!-- Demo info -->
                    <div class="col-lg-4"><div class="row text-center mt-2" style=" margin-top: 0px;">
                        <div class="col-12">
            ...
            <div class="col-md-4 col-xs-12" style="padding:10px 15px 10px 5px">
                ...
                <div class="row">
                    <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                        <i class="fa fa-calculator fa-2x"></i>Statut du projet</h2></div>
                    <!-- Demo info -->
                    <div class="col-lg-4"><div class="row text-center mt-2" style=" margin-top: 0px;">
                        <div class="col-12">
                            <div class="h3 font-weight-bold mb-0" style=" margin-top: 0px;" id="statProj"></div>
                        </div>
                    </div></div><!-- END -->
                </div></div>
            </div>
    ...
    <!-- /#wrapper -->
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/filterProjet.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/projsel1.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/projsel2.js"></script>
