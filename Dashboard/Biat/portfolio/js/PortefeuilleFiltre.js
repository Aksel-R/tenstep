...
function filtrePortefeuille(){
        
         

var SousProtSelctedName=document.getElementById("mylist2").value;
var StructSelctedName=document.getElementById("mylist1").value;
...
document.getElementById("PortefeuilleAff").innerHTML = '<b>NOMBRE DES PROJETS PAR SATUT</b>';
document.getElementById("structAff").innerHTML = '<b>NOMBRE DES PROJETS PAR GARANT FONCTIONNEL</b>';
...
if (SousProtSelctedName != ""){
    filterString+="&$filter=EnterpriseProjectTypeName%20eq%27"+SousProtSelctedName+"%27";
    filterString1+="?$filter=EnterpriseProjectTypeName%20eq%27"+SousProtSelctedName+"%27";
    document.getElementById("projchartDiv").innerHTML = '<canvas id="projchart" style="max-height: 550px;display: block;width: 98%;"></canvas>';
}
if (StructSelctedName != ""){
    filterString+=" and Structureorganisationnelle%20eq%27"+StructSelctedName+"%27";
    filterString1+=" and Structureorganisationnelle%20eq%27"+StructSelctedName+"%27";
    document.getElementById("projchartDiv").innerHTML = '<div id="projchart" style="min-height: 1500px;display: block;max-width:95%;"></div>';
}
    //$("#projchart").height("1000px");
// if ((SousProtSelctedName == "")&&(StructSelctedName == "")) {
//   filtreExercice();
//   return;
// }
if (SousProtSelctedName == "" ) {
	...
	var responseNumberOfProjectsFiltre111 = responseNumberOfProjectsFiltre111 || [];
        var urlNumberOfProjectsFiltre111 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,Structureorganisationnelle,EnterpriseProjectTypeName,TypePortefeuilleProgrammeProjet"+filterString+"%20and%20TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        console.log('urlNumberOfProjectsFiltre111= '+urlNumberOfProjectsFiltre111);
        function LoadAllNumberProjectFiltre111() {
            

            $.ajax({
                url: urlNumberOfProjectsFiltre111,
                method: "GET",
                dataType: "json",
                headers: { Accept: "application/json;odata=verbose" },
                success: function (data) {
                    responseNumberOfProjectsFiltre111 = responseNumberOfProjectsFiltre111.concat(data.d.results);
                    if (data.d.__next) {
                        urlNumberOfProjectsFiltre111 = data.d.__next;
                        LoadAllNumberProjectFiltre111();
                    }
                    ...
                    if (!data.d.__next){
                      ...
                      var arrPortefeuille=[];
                      var arrStructOrg=[];
                      $.each(responseNumberOfProjectsFiltre111, function (key, value) {
                      ...
                      document.getElementById("portefeuillecount").innerHTML = arrPortefeuille.length;
        ...
        LoadAllNumberProjectFiltre111();
        var responseDataSumFiltre111 = responseDataSumFiltre111 || [];
        var urlDataSumFiltre111 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectCost,ProjectActualCost,ProjectCostVariance,ProjectWork,ProjectWorkVariance"+filterString+"%20and%20TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        console.log('urlDataSumFiltre111= '+urlDataSumFiltre111);
        function loadDataSumFiltre111() {
                        var projCost = 0;
            ...
            $.ajax({
                url: urlDataSumFiltre111,
                method: "GET",
                dataType: "json",
                headers: { Accept: "application/json;odata=verbose" },
                success: function (data) {
                    responseDataSumFiltre111 = responseDataSumFiltre111.concat(data.d.results);
                    if (data.d.__next) {
                        urlDataSumFiltre111 = data.d.__next;
                        loadDataSumFiltre111();
                    }

                    $.each(responseDataSumFiltre111, function (key, value) {
        ...
        var responseGovernancePhaseFiltre111 = responseGovernancePhaseFiltre111 || [];
        var urlGovernancePhaseFiltre111 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,ProjectPercentCompleted,Structureorganisationnelle"+filterString+"%20and%20TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        console.log("urlGovernancePhaseFiltre111 "+urlGovernancePhaseFiltre111)
        function LoadBarGovernancePhaseFiltre111() {
            $.ajax({
                url: urlGovernancePhaseFiltre111,

                method: "GET",
                dataType: "json",
                headers: { Accept: "application/json;odata=verbose" },
                success: function (data) {
                    responseGovernancePhaseFiltre111 = responseGovernancePhaseFiltre111.concat(data.d.results);
                    if (data.d.__next) {
                        urlGovernancePhaseFiltre111 = data.d.__next;
                        LoadBarGovernancePhaseFiltre111();
                    }
                    if (!data.d.__next){
                      ...
                      var pievalues=[];
                      var stringChart="";
                      $.each(responseGovernancePhaseFiltre111, function (key, value) {
                        //SousProtSelctedName StructSelctedName
                        var epn="";
                        if (StructSelctedName!="") {
                          epn = value.ProjectName;   
                          stringChart="Projets";                       
                        }else if (StructSelctedName==""){
                          epn = value.Structureorganisationnelle;
                          stringChart="Structure Organisationnelle";
                        }
                          console.log('epn= '+epn);
                      ...
                      for (var i = 0; i < labels.length; i++) {
                        pievalues[i]=parseInt(parseFloat(pievalues[i]/epnCount[i]).toFixed(0));
                      }
        ...
        var responsePhaseChartFiltre111 = responsePhaseChartFiltre111 || [];
        var urlPhaseChartFiltre111 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Statut&"+filterString+"%20and%20TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        function LoadProjectTypeFiltre111() {
            $.ajax({
                url: urlPhaseChartFiltre111,
                ...
                headers: { Accept: "application/json;odata=verbose" },
                success: function (data) {
                    responsePhaseChartFiltre111 = responsePhaseChartFiltre111.concat(data.d.results);
                    if (data.d.__next) {
                        urlPhaseChartFiltre111 = data.d.__next;
                        LoadProjectTypeFiltre111();
                    }
                    var itermeidiaryObject = {};
                    $.each(responsePhaseChartFiltre111, function (key, value) {

                        var epn1Filtre111 = value.Statut;
                        var som1Filtre111 = 0;
                        if (epn1Filtre111 != null) {
                            itermeidiaryObject[epn1Filtre111] = ++itermeidiaryObject[epn1Filtre111] || 1;
                        }
                        var somme1Filtre111 = som1Filtre111;
                    });
                    ...
                    var ctx2Filtre111 = document.getElementById("barsline").getContext('2d');
                    if (window.echartdonut != undefined) {
                        window.echartdonut.destroy();
                    }

                    window.echartdonut = new Chart(ctx2Filtre111, {
                        type: 'doughnut',
                        data: {
                            labels: labels,
                            datasets: [{
        ...
        LoadProjectTypeFiltre111();
         ...
         var response_SousPortefeuilleFiltre111 = response_SousPortefeuilleFiltre111 || [];
        var urlSous_PortefeuilleFiltre111 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=GarantFonctionnel"+filterString+"%20and%20TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        function LoadSous_PortefeuilleFiltre111() {
            $.ajax({
                url: urlSous_PortefeuilleFiltre111,
                ...
                headers: { Accept: "application/json;odata=verbose" },
                success: function (data) {
                    response_SousPortefeuilleFiltre111 = response_SousPortefeuilleFiltre111.concat(data.d.results);
                    if (data.d.__next) {
                        urlSous_PortefeuilleFiltre111 = data.d.__next;
                        LoadSous_PortefeuilleFiltre111();
                    }
                    var itermeidiaryObject1Filtre111 = {};
                    $.each(response_SousPortefeuilleFiltre111, function (key, value) {

                        var epn2Filtre111 = value.GarantFonctionnel;
                        var som2Filtre111 = 0;
                        if (epn2Filtre111 != null) {
                            itermeidiaryObject1Filtre111[epn2Filtre111] = ++itermeidiaryObject1Filtre111[epn2Filtre111] || 1;
                        }
                        var somme2Filtre111 = som2Filtre111;
                    });

                    var finalObject1 = Object.keys(itermeidiaryObject1Filtre111).map(function (key) {
                        return {
                            label: key,
                            y: itermeidiaryObject1Filtre111[key]
                        }
                    });
                    ...
                    var ctx3Filtre111 = document.getElementById("sous_portefeuille").getContext('2d');
                    if (window.echartdonut1 != undefined) {
                        window.echartdonut1.destroy();
                    }

                    window.echartdonut1 = new Chart(ctx3Filtre111, {
                        type: 'doughnut',
                        data: {
                            labels: labels,
                            datasets: [{
        ...
        LoadSous_PortefeuilleFiltre111();
         ...
         var responseTabProjFiltre111 = responseTabProjFiltre111 || [];
        var urlTabProjFiltre111 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects"+filterString1+" and TypePortefeuilleProgrammeProjet eq 'Projet'";
        console.log('urlTabProjFiltre111 '+urlTabProjFiltre111);
        function LoadTableProjectsFiltre111() {
             var sommeCoutReels = 0;
            var sommecoutRestant =0;
            $.ajax({
                url: urlTabProjFiltre111,

                method: "GET",
                dataType: "json",
                headers: { Accept: "application/json;odata=verbose" },
                success: function (data) {
                    responseTabProjFiltre111 = responseTabProjFiltre111.concat(data.d.results);
                    if (data.d.__next) {
                        urlTabProjFiltre111 = data.d.__next;
                        LoadTableProjectsFiltre111();
                    }
                    tableaux = document.getElementById("tableaux");
                    ...
                    $.each(responseTabProjFiltre111, function (key, value) {
