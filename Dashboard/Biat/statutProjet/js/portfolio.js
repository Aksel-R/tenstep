...
$('#mylist4').empty().append('<option value="" selected disabled>NOM DE PROJETS</option>');
    ...
    var lesProjets = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectName,Structureorganisationnelle&$filter=EnterpriseProjectTypeName%20eq%27"+portefeuilleSelect+"%27";
...
var urlAllProjectNumberFiltre1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,Structureorganisationnelle,EnterpriseProjectTypeName,TypePortefeuilleProgrammeProjet&$filter=EnterpriseProjectTypeName%20eq%27"+portefeuilleSelect+"%27";
