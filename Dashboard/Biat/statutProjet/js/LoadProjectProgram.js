...
document.getElementById('nomProjectName').innerHTML = "";
    ...
    var lesProjetsProgramme = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectName&$filter=EnterpriseProjectTypeName%20eq%27"+portefeuilleSelect+"%27 and Structureorganisationnelle eq '"+ProgrammeSelect+"' and TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
    ...
    //*************************glissement********************************************************************//
var urlDateGlissementFiltreProgram1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectStartDate,ProjectFinishDate&$filter=EnterpriseProjectTypeName%20eq%27"+portefeuilleSelect+"%27 and Structureorganisationnelle eq '"+ProgrammeSelect+"'";
...
var urlAllProjectNumberFiltreProgram1 = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,Structureorganisationnelle,EnterpriseProjectTypeName,TypePortefeuilleProgrammeProjet&$filter=EnterpriseProjectTypeName%20eq%27"+portefeuilleSelect+"%27 and Structureorganisationnelle eq '"+ProgrammeSelect+"'";
