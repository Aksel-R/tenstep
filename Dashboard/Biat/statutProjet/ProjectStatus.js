  ...
  <head>
    ...
    <!-- NProgress -->
    <link href="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/css/custom1.min.css" rel="stylesheet">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 col-xs-12">
        <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist2" onchange="loadProjectPrograme();" disabled>
            <option value="" selected disabled>STRUCTURE ORGANISATIONNELLE</option>
        </select>
    </div>
    <div class="col-lg-2 col-xs-12">
...
<div class="row">
    <div class="col-lg-2 col-xs-12" >
            ...
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/e-learning.png'
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                ...
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px">Nombre des Structures organisationnelles</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/discount.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display:none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/yesterday.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display: none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/budget.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa; display: none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/analytics2.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/analytics.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/risk.png' class='img-rounded'
        ...
        <div class="card mb-3" style="max-width: 100%;min-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa; ">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/img/caution.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
    ...
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/jquery-3.3.1.slim.min.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/popper.min.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/bootstrap.min.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/LoadProjectProgram.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/MainFilterData.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/portfolio.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/chart.js@2.8.0.js"></script>
    <!--<script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/chartjs-plugin-labels.js"></script>-->
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/fastclick.js"></script>
    <!-- NProgress -->
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/nprogress.js"></script>
    <!-- iCheck -->
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/icheck.min.js"></script>

    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/echarts.min.js"></script>
    

  <script type="text/javascript" src="/sites/pwa/_catalogs/masterpage/Dashboard/Project_Status/javascript/moment-with-locales.js"></script>
...
var urlAllProjectNumber = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,Structureorganisationnelle,EnterpriseProjectTypeName,TypePortefeuilleProgrammeProjet";
...
//********************************** travail, cout variance, cout projet**********************//
  ...
  var urlDataLeftGlobal= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectCost,ProjectActualCost,ProjectCostVariance,ProjectWork,ProjectWorkVariance,ProjectPercentCompleted&$filter=TypePortefeuilleProgrammeProjet%20eq%27Portefeuille%27";
