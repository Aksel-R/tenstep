...
<head>
    ...
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/css/bootstrap.min.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/css/style.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/css/achevement.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/css/w3.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/css/jquery.dataTables.min.css" rel="stylesheet">
...
<select class="form-item__element form-item__element--select" style="color:black; font-weight:bold;" id="departement" onchange="selectMyList1();mainfilter();">
        <option selected="" value="">Portefeuille</option>
      </select>

      <select class="form-item__element form-item__element--select" style="color:black; font-weight:bold;" id="projecttype" onchange="selectMyList2();mainfilter();">
        <option selected="" value="">Programme</option>
      </select>

      <select class="form-item__element form-item__element--select" style="color:black; font-weight:bold;" id="projectowner" onchange="mainfilter();">
        <option selected="" value="">Chef de projet</option>
      </select>

      <select class="form-item__element form-item__element--select" style="color:black; font-weight:bold;" id="covphase" onchange="mainfilter();">
        <option selected="" value="">Phase de gouvernance</option>
      </select>
...
<script src="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/javascript/filter.js"></script>
<script src="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/javascript/selectDeptFin.js"></script>
<script src="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/javascript/selectTypPr.js"></script>
<script src="/sites/BIAT/_catalogs/masterpage/Dashboard/CoutProject/javascript/selectCpPr.js"></script>

<script src="/sites/BIAT/_catalogs/masterpage/Dashboard/Ressources_Projet/javascript/moment-with-locales.min.js"></script>
...
var lesDirections = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=EnterpriseProjectTypeName,ProjectOwnerName,Phaseàdate,Programme&$filter=EnterpriseProjectTypeName ne null and Programme ne null and ProjectOwnerName ne null";
console.log("lesDirections== "+ lesDirections);
...
var countProj = 0;
                    $.each(responseDirectionName, function (key, value) {
                                    ...
                                    var dirId = value.Programme;

                                     var type = value.EnterpriseProjectTypeName;
                                    var typeId = value.EnterpriseProjectTypeName;

                                     var chefprojet = value.ProjectOwnerName;
                                    var chefprojId = value.ProjectOwnerName;

                                     var phaseprojet = value.Phaseàdate;
                                    var phaseprId = value.Phaseàdate;
                                    ...
                                    opt2[$(this).text()] = $(this).val();
                                     ...
                                     if((phaseprojet!="") && (phaseprojet!=null)){
...
var responseTabgrey = responseTabgrey || [];
    var urlTabgrey = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27No%20Baseline%27 and Types_de_Projet eq 'Page_Maitre'";

    function loadTabgrey() {
console.log("urlTabgrey= "+urlTabgrey);
        $.ajax({
            url: urlTabgrey,
            method: "GET",
            dataType: "json",
            headers: { Accept: "application/json;odata=verbose" },
            success: function (data) {
                responseTabgrey = responseTabgrey.concat(data.d.results);
                if (data.d.__next) {
                    urlTabgrey = data.d.__next;
                    loadTabgrey();
                }
                var arrPrCost = [];
                var arrPrActCost= [];
                ...
                $.each(responseTabgrey, function (key, value) {
                ...
                var tr1;
                tr1 = $("<tr>");
                tr1.append('<td> <div class="row"> <div class="col-xs-1" id="fa3"><i class="fa fa-circle fa-2x" style=" color: #7c7777;"></i></div><div class="col-xs-11 text-lrft" style="font-size: 14px;color: black;"><div id="entreprisesKPI" style="font-weight: 700;"> Pas de référence projet</div></div></div></td>');
    ...
    loadTabgrey();
var responseTabred = responseTabred || [];
    var urlTabred = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27At least 20% over baseline cost%27 and Types_de_Projet eq 'Page_Maitre'";

    function loadTabred() {
console.log("urlTabred= "+urlTabred);
        $.ajax({
            url: urlTabred,
            method: "GET",
            dataType: "json",
            headers: { Accept: "application/json;odata=verbose" },
            success: function (data) {
                responseTabred = responseTabred.concat(data.d.results);
                if (data.d.__next) {
                    urlTabred = data.d.__next;
                    loadTabred();
                }
                var arrPrCost = [];
                var arrPrActCost= [];
                ...
                $.each(responseTabred, function (key, value) {
                ...
                var tr1;
                tr1 = $("<tr>");
                tr1.append('<td> <div class="row"> <div class="col-xs-1" id="fa3"><i class="fa fa-circle fa-2x" style=" color: #f53a3a;"></i></div><div class="col-xs-11 text-lrft" style="font-size: 14px;color: black;"><div id="entreprisesKPI" style="font-weight: 700;"> Supérieur à 20% du coût de référence</div></div></div></td>');
                tr1.append("<td style='font-weight:bold;'> "+ conToMill(prBudgCostSum) +" </td>");
    ...
    loadTabred();
    var urlremplirCostTabred = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/ProjectBaselines?$select=ProjectId,ProjectBaselineCost";
var responseremplirCostTabred = responseremplirCostTabred ||[];
function remplirCostTabred(){

  $.ajax({url:  urlremplirCostTabred,          
                                    method: "GET",
                                    dataType: "json",
                                    headers: {Accept: "application/json;odata=verbose"},       
                                    success: function(data) {     
                                    responseremplirCostTabred = responseremplirCostTabred.concat(data.d.results);
                                        if (data.d.__next) {
                                            urlremplirCostTabred = data.d.__next;
                                            remplirCostTabred();
                                        } 
        ...
        for(var i=1;i<numRows;i++){
            ...
            $.each(responseremplirCostTabred, function(key, value) 
            { 
...
var responseTabyellow = responseTabyellow || [];
    var urlTabyellow = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27Between 10%-20% over baseline cost%27 and Types_de_Projet eq 'Page_Maitre'";

    function loadTabyellow() {
console.log("urlTabyellow= "+urlTabyellow);
        $.ajax({
            url: urlTabyellow,
            method: "GET",
            dataType: "json",
            headers: { Accept: "application/json;odata=verbose" },
            success: function (data) {
                responseTabyellow = responseTabyellow.concat(data.d.results);
                if (data.d.__next) {
                    urlTabyellow = data.d.__next;
                    loadTabyellow();
                }
                var arrPrCost = [];
                var arrPrActCost= [];
                ...
                $.each(responseTabyellow, function (key, value) {
                ...
                var tr1;
                tr1 = $("<tr>");
                tr1.append('<td> <div class="row"> <div class="col-xs-1"> <i class="fa fa-circle fa-2x" style=" color: #ffd81a;"></i></div><div class="col-xs-11 text-lrft" style="font-size: 14px;color: black;"><div id="entreprisesKPI" style="font-weight: 700;"> entre 10%-20% du coût de référence</div></div></div></td>');
                tr1.append("<td style='font-weight:bold;'> "+ conToMill(prBudgCostSum) +" </td>");
                ...
                remplirCostTabyellow();    
            }
        });
    }
    loadTabyellow();
    var urlremplirCostTabyellow = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/ProjectBaselines?$select=ProjectId,ProjectBaselineCost";
var responseremplirCostTabyellow = responseremplirCostTabyellow ||[];
function remplirCostTabyellow(){

  $.ajax({url:  urlremplirCostTabyellow,          
                                    method: "GET",
                                    dataType: "json",
                                    headers: {Accept: "application/json;odata=verbose"},       
                                    success: function(data) {     
                                    responseremplirCostTabyellow = responseremplirCostTabyellow.concat(data.d.results);
                                        if (data.d.__next) {
                                            urlremplirCostTabyellow = data.d.__next;
                                            remplirCostTabyellow();
                                        } 
        ...
        for(var i=1;i<numRows;i++){
            ...
            $.each(responseremplirCostTabyellow, function(key, value) 
            { 
                var projId=value.ProjectId;
                if (projId==idPrTab) {
                    var projBaseCost=parseFloat(value.ProjectBaselineCost).toFixed(2);
...
var responseTabGreen = responseTabGreen || [];
    var urlTabGreen = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27Less than 10% over baseline cost%27 and Types_de_Projet eq 'Page_Maitre'";
...
console.log("urlTabGreen= "+urlTabGreen);
        $.ajax({
            ...
            success: function (data) {
                ...
                var tr1;
                tr1 = $("<tr>");
                tr1.append('<td> <div class="row"> <div class="col-xs-1" id="fa3"><i class="fa fa-circle fa-2x" style=" color: #49bf34;"></i></div><div class="col-xs-11 text-lrft" style="font-size: 14px;color: black;"><div id="entreprisesKPI" style="font-weight: 700;"> inférieur à 10% du coût de référence</div></div></div></td>');
                tr1.append("<td style='font-weight:bold;'> "+ conToMill(prBudgCostSum) +" </td>");
...
var urlremplirCostTab = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,Servicesduprojet,ProjectName,ProjectCost,ProjectActualCost,ProjectCostVariance";
...
function remplirCostTab(){
  ...
  $.ajax({url:  urlremplirCostTab,          
    ...
    var urlLoadKPI = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectCost,ProjectActualCost,ProjectCostVariance&$filter=Types_de_Projet eq 'Page_Maitre'";
    function loadKPI() {
        $.ajax({
            url: urlLoadKPI,
            method: "GET",
