...
function mainfilter() {
	...
	var urlFilterSelected1= "";
  	...
  	if (departement!="") {
  		urlFilterSelected1+="%20and%20Servicesduprojet%20eq%27"+departement+"%27";
        countSelected++;
	    if (countSelected==1) {
	      urlFilterSelected+="&$filter=Servicesduprojet%20eq%27"+departement+"%27";
	    }else{
	      urlFilterSelected+="%20and%20Servicesduprojet%20eq%27"+departement+"%27";
	    }
  	}
    ...
    var urlLoadKPIFilter = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,Servicesduprojet,ProjectCost,ProjectActualCost,ProjectCostVariance"+urlFilterSelected;
...
arroundMax(number);
if(coutprojet > coutreferenceprojet){
...
if(coutprojet < coutreferenceprojet){
        ...
        offset:30,
            min: 0,
            max: arroundMax(coutreferenceprojet),
            plotBands: [{
                from: 0,
                to: parseInt(coutprojet),
                color:  '#b8deff' // orange
            }, {
                from: coutprojet,
                to: coutreferenceprojet,
                color: '#ffc470' // blue
            }]
        }],
...
var responseTabyellowFilter = responseTabyellowFilter || [];
    var urlTabyellowFilter = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Servicesduprojet,ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27Between 10%-20% over baseline cost%27"+urlFilterSelected1;
...
var responseTabGreenFilter = responseTabGreenFilter || [];
    var urlTabGreenFilter = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Servicesduprojet,ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27Less than 10% over baseline cost%27"+urlFilterSelected1;
...
var responseTabredFilter = responseTabredFilter || [];
    var urlTabredFilter = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Servicesduprojet,ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27At least 20% over baseline cost%27"+urlFilterSelected1;
...
var responseTabgreyFilter = responseTabgreyFilter || [];
    var urlTabgreyFilter = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Servicesduprojet,ProjectId,ProjectName,ProjectBudgetCost,ProjectCost,ProjectActualCost,ProjectRemainingCost,ProjectCostVariance&$filter=CostKPI%20eq%27No%20Baseline%27"+urlFilterSelected1;
