function loadListsByProject(){
  ...
  if (projectIdSel!="") {
	...
	var urlProjFilter22Sel1=_spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Programme,ProjectId,ProjectName&$filter=ProjectId%20eq%20guid%27"+projectIdSel+"%27"+exerciseCh;
