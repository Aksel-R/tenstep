function loadListsByPortfolio(){
  ...
  if (portfolioSel!="") {
	...
	var urlProgListFilter=_spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Programme,ProjectId,ProjectName&$filter=ProjectName%20ne%20%27Opérations%20d’administration%20de%20feuilles%20de%20temps%27%20and%20EnterpriseProjectTypeName%20eq%27"+portfolioSel+"%27"+exerciseCh;
	...
	var urlProjFilterSel1=_spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Programme,ProjectId,ProjectName&$filter=ProjectName%20ne%20%27Opérations%20d’administration%20de%20feuilles%20de%20temps%27%20and%20EnterpriseProjectTypeName%20eq%27"+portfolioSel+"%27"+exerciseCh;
