...
if(directionSelectedProj == "ServiceInfrastructure.RA AND B")
  ...
  {
    var directionSelectedProjs = "ServiceInfrastructure.RA";
  var urlDirectionProjects = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,ProjectId,ProjectFinishDate,ProjectStartDate&$filter=startswith(Direction,'"+directionSelectedProjs+"') eq true";
    
  }
  else{

  var urlDirectionProjects = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,ProjectId,ProjectFinishDate,ProjectStartDate&$filter=Direction eq '"+directionSelectedProj+"'";
  }
...
if(directionSelectedProj == "ServiceInfrastructure.RA AND B")

  {
    ...
    var LinkProjetData = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectPercentCompleted,ProjectPercentCompleted,ProjectStartDate,ProjectFinishDate,ProjectName&$filter=startswith(Direction,'"+directionSelectedProj+"') eq true";
  }else{

    var LinkProjetData = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,ProjectPercentCompleted,ProjectPercentCompleted,ProjectStartDate,ProjectFinishDate,ProjectName&$filter=Direction eq '"+directionSelectedProj+"'";
  }
  ...
  function DoughnutChartFilterMDirection()
  {
    ...
    console.log("LinkProjetData= "+ LinkProjetData);
      $.ajax({
                  url: LinkProjetData,
