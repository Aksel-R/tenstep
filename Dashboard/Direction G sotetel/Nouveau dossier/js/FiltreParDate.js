...
{
  $( "#exerciceDates" ).prop( "disabled", true );
...
var urlDoughnutChartDate=  _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectFinishDate,ProjectStartDate,ProjectId,Direction,ProjectPercentCompleted,ProjectName";
...
success: function (data) {
      ...
      borne1=moment(datedebut).format('YYYY-MM-DD');
      borne2=moment(datefin).format('YYYY-MM-DD');
...
function loadTasksKPIs(identifiantProjet,arrIdProj,arrClient,arrProjectName,arrCp,arrMontantG,arrDeb,arrFin,arrAch,borne1,borne2,projectDuration,arrDir,arrCostvariance,arrProjWork,arrPworkvariance,montantGen,coutActuel,cout){
