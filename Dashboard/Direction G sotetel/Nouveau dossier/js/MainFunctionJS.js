...
window.addEventListener('load',function() {
  ...
  var pworkvariance = 0;
        ...
        {                 
              var pCost = parseFloat(value.Montant);
              if (isNaN(pCost)) {
                pCost=0;
              }
              ...
              projCost = parseFloat(projCost) + pCost;
...
//Table Project 
var LinkClient = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectId,Direction,Montant,ProjectFinishDate,ProjectStartDate,Client,ProjectOwnerName,ProjectPercentCompleted,ProjectName,ProjectActualCost";
...
function LoadTableProjectsClient() {
            ...
            {           
              ...
              moment.locale('fr');
                ...
                var coutAct=parseFloat(value.ProjectActualCost).toFixed(3);
