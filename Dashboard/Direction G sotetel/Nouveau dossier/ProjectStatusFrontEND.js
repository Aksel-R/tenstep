...
<div id="headercolor">
    <div>
        <small class="smallRisks">
            <b id="titreProjets">Direction générale  </b> 
        </small>
    </div>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right">
                        ...
                        <div id="projetsKPI" style="font-size: large;">&sum; CA Planifié</div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table" style="border-radius:15px 15px 0px 0px;margin-bottom: 0px;" id="myTable1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 11%; padding-left: 0px;">CA Planifié</th>
                                            <th style="width: 11%; padding-left: 0px;">CA Réalisé</th>
