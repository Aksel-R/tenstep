  <head>
    ...
    <link href="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/css/MiseEnPage.css" rel="stylesheet">
      ...
      <div id="headercolor">
         <div>
            ...
            <small class="smallRisks">
              <u>Suivi et facturation : CA et RG (Direction des Projets)</u>
            </small>
            ...
            <header>
                ...
                <div class="row">
                    ...
                    <div class="col" style="color: black;float:right;">
                        <center>
                          <h6>Société Tunisienne d'Entreprise de Télécommunication</h6>
...
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/ShowPopUpAll.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/javascript/Pagination.js"></script>

<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/showOperations.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/tableauxAttachements.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/tableauxAttachementOperations.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/showPopUpAttachment.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/showPopUpAttachmentOperation.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/ApproveAttachment.js"></script>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
 <script type="text/javascript">
    ...
    //Fonction qui permet d'afficher les list des Projets
        ...
        var urlProjectTypeName = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=Title,id_projet&$filter=startswith(direction, 'Direction des Projets')&$orderby=Created desc";
...
var urlSuiviMain = _spPageContextInfo.webServerRelativeUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=id_projet,Title&$orderby=Title desc";
function main() {
          $.ajax({
                url: urlSuiviMain,
                    ...
                    if (data.d.__next) {
                      ...
                      var attachementTab = [];
                        ...
                        $.each(responseSuiviMain, function (key, value) {
                          if (arrNomProj.indexOf(value.Title)<0) {
                            arrNomProj.push(value.Title);
                            arrIdProj.push(value.id_projet);
                          }
                        });
                        for (var i = 0; i < arrNomProj.length; i++) {
                          loadTab(arrNomProj[i],arrIdProj[i],attachementTab,idoperationTab,identTab,identifiantAttTab,codeEditTab,dateEditTab,nbClientEditTab,clientEditTab,utilisateurEditTab,factureEditTab,DateFactEditTab,AppelIdentTab,CroquisEditTab,PATEditTab,PVRepEditTab,RDPrevuEditTab,RPFactEditTab,RDFactEditTab,chargeSTEditTab,Sous_TraitEditTab,AttacherTab,MontantAttachementTab,TVATab,beneficierTab,nomdeLoperation,id_TasksTab,id_ProjectsTab,arrNomProj,arrIdProj);
                        }
                    }
                }
            });
...
main();
function loadTab(projectName,projetIdentifiant,attachementTab,idoperationTab,identTab,identifiantAttTab,codeEditTab,dateEditTab,nbClientEditTab,clientEditTab,utilisateurEditTab,factureEditTab,DateFactEditTab,AppelIdentTab,CroquisEditTab,PATEditTab,PVRepEditTab,RDPrevuEditTab,RPFactEditTab,RDFactEditTab,chargeSTEditTab,Sous_TraitEditTab,AttacherTab,MontantAttachementTab,TVATab,beneficierTab,nomdeLoperation,id_TasksTab,id_ProjectsTab,arrNomProj,arrIdProj) {
  var genereAllMilestoneMain = genereAllMilestoneMain || [];
  var loadWBSUrlMilestoneMain = _spPageContextInfo.webServerRelativeUrl + "/"+projectName+"/_api/web/lists/getbytitle('Liste_Attachements')/items?$filter=id_projects eq '"+projetIdentifiant+"' and MontantAttachement ne null and codeEdit ne null and AppelIdent ne null and RPFactEdit ne null&$orderby=Created desc";
   ...
   for(var i=0; i<identTab.length;i++)
            {
                var tr;  
                  tr = $("<tr class='rowAttachement' id='"+(tbodyRef.rows.length+ 1)+"'/>");
                        ...
                        tr.append("<td class='td-data' style='display:none;' id='projectName'>"+projectName+"</td>");
...
$("#tableauxAttachement tbody td").each(function() {
    ...
    $(document).ready(function() {
                          $('#tableauxAttachement  tbody tr').on('click', '#glyphiconPrint', function () {
                                ...
                                var projectName = $(this).closest('tr').find('#projectName').val();
                                $(".fade").addClass("in");
                                AfficherArticlesPOPUPALL(projectName,identAttachement);  
