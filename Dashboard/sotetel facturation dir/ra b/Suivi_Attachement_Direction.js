  <head>
    ...
    <link href="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/css/MiseEnPage.css" rel="stylesheet">
      ...
      <div id="headercolor">
         <div>
            ...
            <small class="smallRisks">
              <u>Suivi et facturation : CA et RG (Service Infrastructure RA&B)</u>
            </small>
...
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/showOperations.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/tableauxAttachements.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/tableauxAttachementOperations.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/showPopUpAttachment.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/showPopUpAttachmentOperation.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/ApproveAttachment.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/ApproveAttchmentAll.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/Direction_RA_B/javascript/ShowPopUpAll.js"></script>
...
jQuery(document).ready(function() {
    ...
    //Fonction qui permet d'afficher les list des Projets
        ...
        var urlProjectTypeName = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=Title,id_projet&$filter=startswith(direction, 'ServiceInfrastructure.R')&$orderby=Created desc";
...
var urlSuiviMain = _spPageContextInfo.webServerRelativeUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=id_projet,Title&$filter=startswith(direction, 'ServiceInfrastructure.R')&$orderby=Created desc";
function main() {
          $.ajax({
                url: urlSuiviMain,
