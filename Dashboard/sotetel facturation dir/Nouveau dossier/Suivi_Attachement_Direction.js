...
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionProjet/javascript/ApproveAttchmentAll.js"></script>
...
var urlSuiviMain = _spPageContextInfo.webServerRelativeUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=id_projet,Title&$filter=startswith(direction, 'Direction des Projets')&$orderby=Created desc";
function main() {
          $.ajax({
                url: urlSuiviMain,
