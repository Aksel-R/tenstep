      ...
      <div id="headercolor">
         <div>
            ...
            <small class="smallRisks">
              <u>Suivi et facturation : CA et RG (Direction Service Convergent)</u>
            </small>
...
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/showOperations.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/tableauxAttachements.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/tableauxAttachementOperations.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/showPopUpAttachment.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/showPopUpAttachmentOperation.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/ApproveAttachment.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/ApproveAttchmentAll.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Module_de_facturation_client/DirectionConvegrent/javascript/ShowPopUpAll.js"></script>
...
jQuery(document).ready(function() {
    ...
    //Fonction qui permet d'afficher les list des Projets
        ...
        var urlProjectTypeName = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=Title,id_projet&$filter=startswith(direction, 'ServiceConvergent')&$orderby=Created desc";
...
var urlSuiviMain = _spPageContextInfo.webServerRelativeUrl + "/_api/web/lists/getbytitle('Suivi_Attachement_recu')/items?$select=id_projet,Title&$filter=startswith(direction, 'ServiceConvergent')&$orderby=Created desc";
function main() {
          $.ajax({
                url: urlSuiviMain,
