...
function gotProperty() {                
           ...
           var urlTaskName = _spPageContextInfo.webServerRelativeUrl + "/_api/ProjectData/[en-US]/Projects(guid'1191c36b-f784-ec11-889c-00155dde6963')/Tasks?$select=TaskName,Zone,TaskId&$filter=Zone eq 'Zone 2'";
...
function loadTab(ARRtypeRes,ARRcodeRes,ARRnomRes,ARRunite,ARRquantpr,ARRprix_unites,ARRnomprojet,ARRres1,ARRFTTC) {
  for (var i = 0; i < ARRcodeRes.length; i++) {
      ...
      trSuiv.append("<td class='pun' style='display:none;'><input id='pu'value="+ parseFloat(ARRprix_unites[i]).toFixed(3) +" type='text'  style='width: 80px; height: 30px border:none; text-align:center;' readonly class='refresh_prices row_quantity1'/></td>");
      ...
      trSuiv.append("<td class='zoneArticle' style='display:none;'>Zone 2</td>");
