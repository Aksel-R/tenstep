...
_spBodyOnLoadFunctionNames.push("Directions");
      ...
      var urlAss = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects(guid'1191c36b-f784-ec11-889c-00155dde6963')/Assignments?$select=ResourceName,ResourceId&$filter=ProjectId%20eq%20guid%271191c36b-f784-ec11-889c-00155dde6963%27%20and%20ResourceName%20ne%20%27Ressource%20non%20affectée%27%20and%20ResourceName%20ne%20%27Ressource%20locale%20générique%27&$apply=groupby(ResourceId,ResourceName)";
      //console.log("urlAss= "+urlAss);
      function filterAss(){
                $.ajax({url:  urlAss,          
                         method: "GET",
                         dataType: "json",
...
function loadTab(ARRtypeRes,ARRcodeRes,ARRnomRes,ARRunite,ARRquantpr,ARRprix_unites,ARRnomprojet,ARRres1,ARRFTTC) {
	for (var i = 0; i < ARRcodeRes.length; i++) {
			...
			trSuiv.append("<td style='display:none;'><input id='pu' type='text' value="+ parseFloat(ARRprix_unites[i]).toFixed(3) +" style='width: 80px; height: 30px border:none; text-align:center;' readonly class='refresh_prices row_quantity'/></td>");          
			...
			trSuiv.append("<td class='zoneArticle' style='display:none;'>Zone 1</td>");
