...
<body>
    ...
    <div class="preload">
        <img src="http://i.imgur.com/KUJoe.gif" class="loadingPage">
    </div>
            ...
            <div class="container1" style="width:100%;background-color: #faf7f7;">
                <div class="card" style="margin-top: 10px;">
                    <header>
                        ...
                        <div class="row">
                            <div class="col">
                                <img src="/PWA/_catalogs/masterpage/sotetel.png" width="150" height="80"
                            ...
                            <div class="title">
                                ...
                                <strong><input type="text" readonly id="UniqueCodeAttDyn"
                                        style=" font-size: 13px; font-weight: bolder;width:40px; background-color:white; border:none; display:none;" /><input
                                        type="text" readonly id="pcode1"
                                        style=" font-size: 13px; font-weight: bolder;width:50px; background-color:white; border:none; " />/<input
                                        type="text" readonly id="codeoracleentete"
                                        style=" font-size: 15px; font-weight: bolder;width:90px; background-color:white; border:none; text-align: center;" />
                                    /SOTETEL</strong>
                            </div>
                            ...
                            <div class="col company-details">
                                <center>
                                    ...
                                    <h5 style="font-family:auto; color:black;">Télécommunication Service Sous Traitance
                                    </h5>
                                    <br>
                                    <input type="date" id="date" readonly=""
                                        style="border:none; width:200px; float:right;margin-right: 10px;">
                                </center>
                            </div>
                        </div>
                    </header>
                            ...
                            <div class="card-body d-flex flex-column align-items-start">
                                <table border="0" width="100%">
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <div type="text" class="form-control" id="codeoracle" onChange="test()"
                                                style="width: 100%; height: 35px; background-color:transparent;"></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <div type="text" class="form-control" id="chefprojet" required
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <input class="form-control" type="date" value="" id="start" required
                                                name="datepicker" style="width: 100%; height: 35px;">
                                        </td>
                                    </tr>
                                    ...
                                    <tr height="50px">
                                        <td>
                                            <div class="mb-1 text-muted"><strong>Délai de Réalisation : *</strong></div>
                                        </td>
                                        <td>
                                            <div id="lignes">
                                                <input class="form-control" onkeypress="process(event, this)"
                                                    id="dureeMois" min="0" max="12" type="number" placeholder="Mois"
                                                    style="width: 80px; height: 35px;" required />&ensp;<p>Mois</p>
                                                &emsp;
                                                <input class="form-control" onkeypress="process(event, this)"
                                                    id="dureeJours" min="0" max="31" type="number" placeholder="Jours"
                                                    style="width: 80px; height: 35px;" required />&ensp;<p>Jour</p></br>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <select id="operations" class="form-control"
                                                style="width: 100%; height: 35px;" placeholder="Type de Commande">
                                    ...
                                    <tr height="50px">
                                        <td>
                                            <div class="mb-1 text-muted"><strong>Prix Par Zone : *</strong></div>
                                        </td>
                                        <td>
                                            <select class="form-control" name="filter" id="zone"
                                                placeholder="Choisir votre Zone" onChange="test3();"
                                                style="width: 100%; height: 35px;">
                                                <option value="ChoisirlaZone">Choisir la Zone</option>
                                                <option value="Zone 1">Zone 1 (Prix unit)</option>
                                                <option value="Zone 2">Zone 2 (Prix zone nord)</option>
                                                <option value="Zone 3">Zone 3 (prix zone centre)</option>
                                                <option value="Zone 4">Zone 4 (Prix zone sud)</option>
                                                <option value="Zone 5">Zone 5 (Prix de vente)</option>
                                            </select>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="card-body d-flex flex-column align-items-start">
                                <table border="0" width="100%">
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <select class="form-control" id="nomprojet" onChange='test()'
                                                style="width: 100%; height: 35px;">
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td><span type="text" class="form-control" id="directionprojet"
                                                style="width: 100%; height: 35px;"></span></td>
                                    </tr>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <div type="text" class="form-control" id="poleprojet" onChange="test()"
                                                style="width: 100%; height: 35px;" value="Pole">
                                        </td>
                                    </tr>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <select id="listedest" class="form-control"
                                                style="width: 100%; height: 35px;"
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <p id="soustaint" style="color:red; display:none"><i>Vérifier le
                                                    Sous_Traitant</i></p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <select id="liste" data-live-search="true" class="form-control"
                                                placeholder="Choisir une tâche" style="width: 100%; height: 35px;">
                                                <option value="">Choisir une Opération</option>
                                            </select>
                                            <p id="optache" style="color:red; display:none"><i>Vérifier opération</i>
                                            </p>

                                            <input type="text" class="form-control" id="SousOp"
                                                placeholder="Sous_Opération"
                                                style="width: 100%; height: 35px; background-color:white;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <p id="sousoperation" style="color:red; display:none"><i>Vérifier
                                                    Sous_Opération</i></p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <select class="form-control" id="size" placeholder="Choisir TVA% "
                                                style="width: 30%; height: 30px;" onChange='refreshPrices()'>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td>
                                            <textarea id="comments" class="md-textarea form-control" rows="3"
                ...
                <div class="card-body d-flex flex-column align-items-start">
                    <table border="0" style="width: 40%;">
                        <tr>
                            ...
                            <td><textarea id="siteprojet" class="md-textarea form-control" placeholder="Site" rows="2"
                                    style="width : 100%"></textarea></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <p id="sitessotele" style=" float:right; color:red; display:none"><i>Vérifier votre
                                        Site</i>
                                </p>
                            </td>
                        </tr>
                ...
                <div id="ExcelImport">
                    <div class="col-md-12" style=" padding: 0px">
                        <div class="card " style="margin-bottom: 20px; padding: 0px">
                            <div class="card-body">
                                <table id="tableau" class="table table-striped table-bordered table-sm" cellspacing="10"
                                    width="100%">
                                    <tr id="theadcolor">
                                        ...
                                        <th scope="col" style="display:none">Prix Unit</th>
                                        <th scope="col" style="display:none">Prix Zone Nord</th>
                                        <th scope="col" style="display:none">Prix Zone Centre</th>
                                        <th scope="col" style="display:none">Prix Zone Sud</th>
                                        <th scope="col" style="display:none">Prix Zone Vente</th>
                                ...
                                <table class="table table-clear" style="color: black;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="right" style="width:100%;">
                                                <div class="form-control" style="width:100%; text-align:center;"
                                                    type="text" name="number" value="" readonly id="ht" />
                                            </td>
                                            <td class="right">
                                                <p>DT</p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="right" style="width:100%;">
                                                <div class="form-control" style="width:100%; text-align:center;"
                                                    type="text" name="number" value="" readonly id="tva" />
                                            </td>
                                            <td class="right">
                                                <p>DT</p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="right" style="width:100%;">
                                                <div class="form-control" style="width:100%; text-align:center;"
                                                    type="text" name="number" value="" readonly id="ttc" />
                                            </td>
                                            <td class="right">
                                                <p>DT</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="left">
                                                <button id="chk" type="submit"
                                                    onclick="verifierSiteOp(); verifierLesChamps();"
                                                    class="confirmerDevis btn btn-primary" name="chk">Valider Les
                                                    champs</button>
                                            </td>
                                            <td class="left">
                                                <button id="approuveValidation" type="submit"
                                                    class="btn btn-info">Approuver
                                                    le devis</button>
                                                <button type="submit" id="modal-dialog" data-modal-type="confirm"
                                                    class="btn btn-primary">Enregistrer Devis</button>
                                            </td>
    ...
    <div id="overlay">
        <div id="popup">
            <div class="form-group">
                <span class="popuptext" id="myPopup">Votre devis est en cours d'enregistrement... Merci de patienter
...
<link rel="stylesheet" href="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/css_Library/bootstrap.4.1.1.min.css"/>
<link rel="stylesheet" href="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/css_Library/bootstrap.min.css"/>
<link rel="stylesheet" href="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/css_Library/bootstrap3.0.4.min.css"/>
<link rel="stylesheet" href="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/css_Library/bootstrap-select.css"/>
<link rel="stylesheet" href="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/css_Library/Mise_en_Forme1.css"/>

<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/jquery.2.1.4.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/jquery.min.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/jquery-2.1.0.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/jquery-34.0.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.SPServices/2014.02/jquery.SPServices-2014.02.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/jquery1.min.js"></script>
    <script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/popper.min.js"></script>
    <script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/bootstrap1.min.js"></script>
    

<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/bootstrap.3.4.0.min.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/bootstrap.bundle.min.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/bootstrap.min.js"></script>
<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/bootstrap-select.min.js"></script>

<script type="text/javascript" src="/PWA/CONTRAT%20CADRE%20GRE%20A%20GRE%20TT%20RENFORCEMENT%20DES%20SITES%20RADIOS%202022/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Javascript_Traitements_Duplicate/Insertion_recuperationDuplicate.js"></script>
<script type="text/javascript" src="/PWA/_catalogs/masterpage/Devis_Sotetel/Library_MomentJS/moment-with-locales.js"></script>

<script src="/PWA/_catalogs/masterpage/Devis_Sotetel/Formulaire_Site_De_Projet/Jquery_Library/jquery.num2words.js"></script>
...
jQuery(document).ready(function() {
    jQuery('#loader-wrapper').fadeOut(50000);
    jQuery('#customers').fadeIn(45000);
