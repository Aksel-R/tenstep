...
<head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1">
     ...
     <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/select2-bootstrap.min.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/select2.min.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/bootstrap.min.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/bootstrap.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/style.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/font-awesome.css" rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/styleFormFrontEnd.css"
        rel="stylesheet">
    <link href="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/css/w3.css" rel="stylesheet">
    <style>
        body {
            margin: 0;
            font-family: Arial
...
<select id="resourcePart" style="width:100%;" multiple="multiple" onchange="mainFilter1();"></select>
        ...
        <div class="col-12" style="padding: 0px">
            <div class="x_content table-responsive">
                <table id="tableaux" class="table table-striped table-bordered">
                    <thead style="background-color: #21429b; color: white;">
                        <tr>
    ...
    <script src="/sites/BIAT/_catalogs/masterpage/Dashboard/Recapitulatif/javascript/custom.min.js"></script>
    <script src="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/javascript/timesheeteFilter.js"></script>
    <script src="/sites/BIAT/_catalogs/masterpage/Dashboard/Detail_timesheet/javascript/MainFunction.js"></script>
