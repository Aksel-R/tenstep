...
<head>
    ...
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/bootstrap.min.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/bootstrap.css"  rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/style.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/achevement.css"  rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/dataTables.bootstrap4.min.css"  rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/w3.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/css/jquery.dataTables.min.css" rel="stylesheet">
...
<div id="loader-wrapper" style="display:none">
            ...
            <div class="row">
                ...
                <div class="row" id="row01">
                    <div class="col-md-12 col-xs-12" style="padding-right: 5px;">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-calendar fa-2x"></i> Maitrise des délais
                                </h3>
                            </div>
                            <div class="panel-body" style="padding: 0px 15px;">
                                <div class="row">
                                    <div class="col-md-4 col-xs-12" style="padding: 10px;">
                                        <div class="card1" id="nbProjclott">
                                            <h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;" >Nombre de projets qui auraient dû être clôturés
                                            </h2>
                                        ...
                                        <div ><H4 style="margin-top: 0px;color: black;font-weight: bolder;text-align: center;">Liste de projets qui auraient dû étre clôturés</H4></div>
                                            <div class="tableFixHead" style="overflow-y:auto;height: 215px">
                                                <table class="table table-bordered table-hover table-striped" style="border-radius:7px" id="tableProjetDuCloture">
                                                    <thead style="background-image: linear-gradient(225deg, #f18572 20%, #fceac5 80%);color: black;">
                                                        <tr>
                                ...
                                <div class="row" id="row0">
                                    <div class="col-md-6 col-xs-12" style="padding: 5px;">
                                        <div class="rounded-lg p-3 shadow" style="background-image: linear-gradient(225deg, #fceac5 20%,   #f18572 80%);color: black;" id="rendeClotProj">
                                            <div class="row">
                                                <div class="col-lg-8">
                                    ...
                                    <div class="col-md-6 col-xs-12" style="padding: 5px;">
                                        <div class="rounded-lg p-3 shadow" style="background-image: linear-gradient(225deg, #f18572 20%, #fceac5 80%);color: black;" id="clotProj">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                                    ...
                                    <div class="col-md-6 col-xs-12" style="padding: 5px;">
                                        <div class="rounded-lg p-3 shadow" style="background-image: linear-gradient(225deg, #fceac5 20%,   #f18572 80%);color: black;" id="clottRetardDebProj">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                                    ...
                                    <div class="col-md-6 col-xs-12" style="padding: 5px;">
                                        <div class="rounded-lg p-3 shadow" style="background-image: linear-gradient(225deg, #f18572 20%, #fceac5 80%);color: black;" id="clottAvancedDebProj">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
    ...
    <!-- /#wrapper -->
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/jquery3.4.1.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/Chart.min.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/filterApercuProgramme.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/progsel11.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/typeSel.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/moment-with-locales.min.js"></script>
    ...
    $.ajax({
                  ...
                  success: function (data) {
                      ...
                      $.each(responseSelectPortefeuille, function (key, value) {
                         if (value.EnterpriseProjectTypeName!=null && value.EnterpriseProjectTypeName == "Portefeuille schéma directeur SI (2023-2025)") {
