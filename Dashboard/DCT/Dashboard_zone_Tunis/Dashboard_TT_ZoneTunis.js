  ...
  <head>
    ...
    <!-- Bootstrap -->
    <link href="/DCTPWA/_catalogs/masterpage/Dashboard/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="/DCTPWA/_catalogs/masterpage/Dashboard/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->

    <link href="/DCTPWA/_catalogs/masterpage/Dashboard/css/custom1.min.css" rel="stylesheet">
...
<div id="overlay">
    ...
    Loading...
      ...
      <div id="headercolor">
          ...
          <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist4" onchange="">
...
<script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_Tunis/javascript/Dashboard_TT_filtrage1_zoneTunis.js"></script>
<script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_Tunis/javascript/Dashboard_TT_filtrage2_zoneTunis.js"></script>

    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_nord/javascript/jquery-3.3.1.slim.min.js"></script>
    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_nord/javascript/popper.min.js"></script>
    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_nord/javascript/bootstrap1.min.js"></script>

    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/chart.js@2.8.0.js"></script>

    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/chartjs-plugin-datalabels@0.5.0"></script>

    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/chartjs-plugin-labels.js"></script>

    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/fastclick.js"></script>
    <!-- NProgress -->
    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/nprogress.js"></script>
    <!-- iCheck -->
    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/icheck.min.js"></script>

    <script src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/echarts.min.js"></script>

   



  <script type="text/javascript" src="/DCTPWA/_catalogs/masterpage/Dashboard/javascript/moment-with-locales.js"></script>
...
var responseRegionIpmsan = responseRegionIpmsan ||[];
var urlRegionIpmsan = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName&$filter=ProjectId%20eq%20guid%2716adcbd7-0866-eb11-b5bf-b4b686eaaa32%27"
function LoadRegionList() {

            $.ajax({url: urlRegionIpmsan,
                                    ...
                                    responseRegionIpmsan = responseRegionIpmsan.concat(data.d.results);
                                        if (data.d.__next) {
                                            urlRegionIpmsan = data.d.__next;
                                            LoadRegionList();
                                        }    
                                    var dataResults = data.d.results;
                          var listItemInfo2 = "";      
                          console.log("urlRegionIpmsan= "+urlRegionIpmsan);      
            $.each(responseRegionIpmsan, function(key, value) 
            {           
...
LoadRegionList();
   ...
   var urlRegion122 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects(guid'16adcbd7-0866-eb11-b5bf-b4b686eaaa32')/Tasks?$select=DCT_DRT&$filter=DCT_DRT ne null and TaskName%20eq%20%27Installation équipement%27";

function LoadRegionList1() {
  //Remove_options();
            $.ajax({url:  urlRegion122, 
...
//var responseSprintListOption = responseSprintListOption ||[];
function LoadSprintList1() {

var urlSprintListOption = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects(guid'16adcbd7-0866-eb11-b5bf-b4b686eaaa32')/Tasks?$select=Ch_Sprint&$filter=TaskName eq 'Génie Civil' or TaskName eq 'Basculement et monitoring' or TaskName eq 'Survey' or TaskName eq 'Electrification' or TaskName eq 'Installation équipement' or TaskName eq 'Autorisation' or TaskName eq 'Tirage FO' or TaskName eq 'Réception de site'";
            $.ajax({url: urlSprintListOption,
  //Remove_optionsForSprint   
                                    ...
                                    headers: {Accept: "application/json;odata=verbose"},       
                                    success: function(data) { /*
                                    responseSprintListOption = responseSprintListOption.concat(data.d.results);
                                        if (data.d.__next) {
                                            urlSprintListOption = data.d.__next;
                                            LoadSprintList1();
                                        }    */
                                    var dataResults = data.d.results;
                          var listItemInfo2 = "";            
...
function LoadRegionList1() {
  var urlRegion = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$filter=TaskName%20eq%20%27Installation équipement%27";
            $.ajax({url:  urlRegion, 
