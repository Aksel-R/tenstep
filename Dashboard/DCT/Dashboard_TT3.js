        ...
        <div class="right_col" role="main">
             ...
             <div class="row">
                      ...
                      <table id="tableaux"  class="table table-striped table-bordered jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">%Achevé</th>
                            <th class="column-title" style="display:none;">%Achevé dans les délais</th>
                            <th class="column-title" style="display:none;">%Achevé hors délais</th>
                            </th>
                          </tr>
                        ...
                        <tr><td>Survey</td><td><div  id="verifier" /></td><td><div id="SurveyComplete"/></td><td id="SurveyCompletePercent"></td><td id="SurveyCompleteInDeadlines" style="display:none;"></td><td id="SurveyOutOfTime" style="display:none;"></td></tr> 
                        <tr><td>Autorisation</td><td><div  id="Autorisation" /></td><td><div id="AutorisationComplete"/></td><td id="AutorisationCompletePercent"></td><td id="AutorisationCompleteInDeadlines" style="display:none;"></td><td id="AutorisationOutOfTime" style="display:none;"></td></tr> 
                        <tr><td>Génie civil</td><td><div  id="gCivil" /></td><td><div id="civilComplete"/></td><td id="civilCompletePercent"></td><td id="civilCompleteInDeadlines" style="display:none;"></td><td id="civilOutOfTime" style="display:none;"></td></tr>
                        <tr><td>Electrification</td><td><div  id="Electrification" /></td><td><div id="ElectrificationComplete"/></td><td id="ElectrificationCompletepercent"></td><td id="ElectrificationCompleteInDeadlines" style="display:none;"></td><td id="ElectrificationOutOfTime" style="display:none;"></td></tr>
                        <tr><td>Tirage FO</td><td><div  id="TirageFo" /></td><td><div id="TirageComplete"/></td><td id="TirageCompletePercent"></td><td id="TirageCompleteInDeadlines" style="display:none;"></td><td id="TirageOutOfTime" style="display:none;"></td></tr>
                        <tr><td>Installation équipement</td><td><div  id="Installation" /></td><td><div id="InstallationComplete"/></td><td id="InstallationCompletePercent"></td><td id="InstallationCompleteInDeadlines" style="display:none;"></td><td id="InstallationOutOfTime" style="display:none;"></td></tr>
                        <tr><td>Réception de site</td><td><div  id="Reception" /></td><td><div id="ReceptionComplete"/></td><td id="ReceptionCompletePercent"></td><td id="ReceptionCompleteInDeadlines" style="display:none;"></td><td id="ReceptionOutOfTime" style="display:none;"></td></tr>
                        <tr><td>Basculement et monitoring</td><td><div  id="SWAP" /></td><td><div id="SWAPComplete"/></td><td id="SWAPCompletePercent"></td><td id="SWAPCompleteInDeadlines" style="display:none;"></td><td id="SWAPOutOfTime" style="display:none;"></td></tr>
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="font-family: cursive; font-style: normal;">Evolution reste à réaliser par semaine</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<div class="col-md-7 col-sm-5 col-xs-12">
              ...
              <div class="table-responsive">
                      <table  id="Scooptab" class="table table-striped table-bordered jambo_table bulk_action">
                        ...
                        <tbody>
                            ...
                            <tr><td>Installation équipement</td><td><div  id="InstallationPlan" /></td><td><div id="InstallationRealiser"/></td></tr>
    ...
    <script src="/PT/_catalogs/masterpage/Dashboard/javascript/Dashboard_TT_filtrage1.js"></script>
    <script src="/PT/_catalogs/masterpage/Dashboard/javascript/Dashboard_TT_filtrage2.js"></script>
...
//**********************************************************************************************
//Avant filtrage
var url7 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Survey%27";
    ...
    function GetListItemsSurvey(){
        return $.ajax({
            ...
            success: function(data){
                   ...
                   if((Identifiant == "cacd4332-3db2-ea11-a129-b0fc36e2e03c")||(Identifiant == "aade112c-3fb2-ea11-a129-b0fc36e2e03c")||(Identifiant == "62598f36-41b2-ea11-a129-b0fc36e2e03c")||(Identifiant == "246a0f14-42b2-ea11-a129-b0fc36e2e03c"))
                    {
                      ...
                      var percentComplete = value.TaskPercentCompleted;
                          ...
                          {
                            SurveyComplete++;
                            //console.log("finProjRéel= "+finProjRéel);
                              if(moment(ActualFFDate).isSameOrBefore(lateFinishDate)){
                ...
                Survey =sommes;
                SurveyOutOfTime = Survey - SurveyCompleteInDeadlines; 
...
GetListItemsAutorisation();
 ...
 var url5 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish&$filter=TaskName%20eq%20%27Génie Civil%27";
...
GetListItemsGenieCivil();
 ...
 var url4 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish&$filter=TaskName%20eq%20%27Electrification%27";
...
GetListItemsElectrification();
 ...
 var url3 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish&$filter=TaskName%20eq%20%27Installation équipement%27";
...
GetListItemsInstallation();
 ...
 var url2 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish&$filter=TaskName%20eq%20%27Réception de site%27";
...
GetListItemsRecepSite();
 ...
 var url1 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish&$filter=TaskName%20eq%20%27Basculement%20et%20Monitoring%27%20and%20TaskName%20eq%20%27Basculement%20et%20monitoring%27";
...
GetListItems();
 ...
 var url8 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish&$filter=TaskName%20eq%20%27Tirage%20FO%27";
...
var urlPlaniRealSurvey = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Survey%27";
var responsePlanRealSurvey= responsePlanRealSurvey || [];

function GetListItemsPlanRealSurvey(){
  window.nextWeekEnd = moment().day(4); 
        return $.ajax({
                   ...
                   if((Identifiant == "cacd4332-3db2-ea11-a129-b0fc36e2e03c")||(Identifiant == "aade112c-3fb2-ea11-a129-b0fc36e2e03c")||(Identifiant == "62598f36-41b2-ea11-a129-b0fc36e2e03c")||(Identifiant == "246a0f14-42b2-ea11-a129-b0fc36e2e03c"))
                    {
                      ...
                      var mmEnd = moment(window.nextWeekEnd).format('L');
                    var actualFinishDate=value.TaskActualFinishDate;
                    var actualfinishdateCompare = moment(actualFinishDate).format('L');
...
var urlPlaniRealAutorisation = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Autorisation%27";
...
var urlPlaniRealGenieCivil = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Génie Civil%27";
...
var urlPlaniRealElectrification = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Electrification%27";
...
var urlPlaniRealTirage = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=startswith(TaskName,'tirage fo')";
...
var urlPlaniRealInstall = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Installation équipement%27";
...
function GetListItemsPlanRealInstall(){
        ...
        document.getElementById('InstallationPlan').innerHTML = resultPlanife;
...
var urlPlaniRealReception = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Réception de site%27";
...
var urlPlaniRealBasculement = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=ProjectName,TaskName,ProjectId,TaskPercentCompleted,TaskLateFinish,TaskFinishDate&$filter=TaskName%20eq%20%27Basculement et monitoring%27";
