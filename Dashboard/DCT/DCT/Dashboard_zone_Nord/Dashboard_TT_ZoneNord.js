    ...
    Loading...
      ...
      <div id="headercolor">
          <div>
            ...
            <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist1" onchange="MainFilter3(); MainFilter2();">
                 
            </select>
            <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist2" onchange="MainFilter();">
                 <option value=""selected>Les régions</option>
            </select>
            <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist3" onchange="MainFilterVDSLPOTS(); Remove_optionsForSprint();">
...
<script src="/PT/_catalogs/masterpage/Dashboard/Dashboard_zone_nord/javascript/Dashboard_TT_filtrage1_zoneNord.js"></script>
<script src="/PT/_catalogs/masterpage/Dashboard/Dashboard_zone_nord/javascript/Dashboard_TT_filtrage2_zoneNord.js"></script>
...
function LoadSprintList() {
            ...
            $.ajax({url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=Ch_Sprint&$filter=Ch_Sprint%20ne%20null and ProjectId%20eq%20guid%27aade112c-3fb2-ea11-a129-b0fc36e2e03c%27",
