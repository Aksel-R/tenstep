...
<script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_Sud/javascript/Dashboard_TT_filtrage1_zoneSud.js"></script>
<script src="/DCTPWA/_catalogs/masterpage/Dashboard/Dashboard_zone_Sud/javascript/Dashboard_TT_filtrage2_zoneSud.js"></script>
...
var urlRegionIpmsan = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName&$filter=ProjectId%20eq%20guid%272b8c6cc4-8581-eb11-a383-005056af8f76%27"
...
LoadRegionList();
   ...
   var urlRegion122 = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects(guid'2b8c6cc4-8581-eb11-a383-005056af8f76')/Tasks?$select=DCT_DRT&$filter=DCT_DRT ne null and TaskName%20eq%20%27Installation équipement%27";
...
var urlSprintListOption = _spPageContextInfo.webAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects(guid'2b8c6cc4-8581-eb11-a383-005056af8f76')/Tasks?$select=Ch_Sprint&$filter=TaskName eq 'Génie Civil' or TaskName eq 'Basculement et monitoring' or TaskName eq 'Survey' or TaskName eq 'Electrification' or TaskName eq 'Installation équipement' or TaskName eq 'Autorisation' or TaskName eq 'Tirage FO' or TaskName eq 'Réception de site'";
