    ...
    Loading...
      ...
      <div id="headercolor">
          <div>
            ...
            <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist1" onchange="MainFilter3(); MainFilter2(); MainFilter22();">
            ...
            <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist3" onchange="MainFilterVDSLPOTS(); Remove_optionsForSprint1();">
        ...
        <div class="right_col" role="main">
             ...
             <div class="row">
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="font-family: cursive; font-style: normal;">Situation global par phase</h2>
               ...
               <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <h3 style="display:none;" id="Evolution">Pas de réalisations</h3>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="font-family: cursive; font-style: normal;">Capacité additionnelle</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<div class="col-md-7 col-sm-5 col-xs-12">
    ...
    <script src="/PT/_catalogs/masterpage/Dashboard/javascript/FiltrageDuplicateTestVersion/Dashboard_TT_filtrage2_duplicate.js"></script>
    <script src="/PT/_catalogs/masterpage/Dashboard/javascript/FiltrageDuplicateTestVersion/Dashboard_TT_filtrage1_duplicate.js"></script>
    <script src="/PT/_catalogs/masterpage/Dashboard/javascript/FiltrageDuplicateTestVersion/Dashboard_TT_filtrage1_duplicate_Sprint.js"></script>
...
function LoadRegionList() {
            ...
            $.ajax({url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,ProjectId&$filter=ProjectId%20eq%20guid%27cacd4332-3db2-ea11-a129-b0fc36e2e03c%27%20or%20ProjectId%20eq%20guid%27aade112c-3fb2-ea11-a129-b0fc36e2e03c%27%20or%20ProjectId%20eq%20guid%2762598f36-41b2-ea11-a129-b0fc36e2e03c%27%20or%20ProjectId%20eq%20guid%27246a0f14-42b2-ea11-a129-b0fc36e2e03c%27",   
...
/*function LoadSprintList() {
            ...
            $.ajax({url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Tasks?$select=Ch_Sprint&$filter=Ch_Sprint%20ne%20null and ProjectId%20eq%20guid%27cacd4332-3db2-ea11-a129-b0fc36e2e03c%27%20or%20ProjectId%20eq%20guid%27aade112c-3fb2-ea11-a129-b0fc36e2e03c%27%20or%20ProjectId%20eq%20guid%2762598f36-41b2-ea11-a129-b0fc36e2e03c%27%20or%20ProjectId%20eq%20guid%27246a0f14-42b2-ea11-a129-b0fc36e2e03c%27",
  //Remove_optionsForSprint   
  ...
  _spBodyOnLoadFunctionNames.push("LoadSprintList");*/
...
var urlInstallation = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Génie Civil' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Génie Civil' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Génie Civil' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Génie Civil' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
...
window.sSwap1 = moment().day(8); 
 ...
 var urlAutorisation = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Autorisation' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Autorisation' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Autorisation' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Autorisation' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
...
GetListItemsSwap5s();
 ...
 var urlSwap = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Basculement et monitoring' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Basculement et monitoring' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Basculement et monitoring' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Basculement et monitoring' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
...
var urlElectri = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Electrification' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Electrification' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Electrification' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Electrification' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
...
GetListItemsElectr7();
  ...
  sSwap7=moment(sSwap7).format("YYYY-MM-DD");
    ...
    window.sSwap8Rec = moment("2020-02-17");
  window.sSwap8Rec=moment(sSwap8Rec).format("YYYY-MM-DD");

 var urlReceptSitei = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap8Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap8Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap8Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap8Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
        return $.ajax({
            url: urlReceptSitei,  
            method: "GET",  
            headers: {  
...
GetListItemsReceptSite();
  ...
  window.sSwap7Rec = moment().day(-34);
  sSwap7Rec=moment(sSwap7Rec).format("YYYY-MM-DD");

  window.sSwap8 = moment().day(-41);
  sSwap8=moment(sSwap8).format("YYYY-MM-DD");

 var urlReceptSitei = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap7Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap7Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap7Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap7Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
        return $.ajax({
            url: urlReceptSitei,  
            method: "GET",  
            headers: {  
...
GetListItemsReceptSite1();
  ...
  window.sSwap6Rec = moment().day(-28);
  sSwap6Rec=moment(sSwap6Rec).format("YYYY-MM-DD");
...
var urlReceptSitei = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap6Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap6Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap6Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap6Rec+"' and TaskName eq 'Réception de site' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
        return $.ajax({
            url: urlReceptSitei,  
            method: "GET",  
            headers: {  
...
var urlReceptSitei = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Réception de site' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Réception de site' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Réception de site' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Réception de site' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
...
var urlTirageFO = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$inlinecount=allpages&$select=TaskPercentCompleted&$filter=TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Tirage FO' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Tirage FO' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Tirage FO' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' or TaskStartDate lt datetime'"+sSwap2+"' and TaskName eq 'Tirage FO' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c'";
...
var responseVDSL1 = responseVDSL1 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap8VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap8VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap8VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap8VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL2 = responseVDSL2 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL1 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap7VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap7VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap7VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap7VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL3 = responseVDSL3 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL2 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap6VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap6VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap6VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap6VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL4 = responseVDSL4 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL3 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap5VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap5VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap5VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap5VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL5 = responseVDSL5 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL4 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap4VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap4VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap4VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap4VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL6 = responseVDSL6 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL5 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap3VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap3VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap3VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap3VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL7 = responseVDSL7 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL6 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap2VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap2VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap2VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap2VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responseVDSL8 = responseVDSL8 || [];  // this variable is used for storing list items
 ...
 var sommeVDSL=0;
  ...
  var urlVDSL7 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_VDSL&$filter=TaskStartDate lt datetime'"+sSwap1VDSL+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap1VDSL+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap1VDSL+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap1VDSL+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS1 = responsePOTS1 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap8POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap8POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap8POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap8POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS2 = responsePOTS2 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS1 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap7POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap7POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap7POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap7POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS3 = responsePOTS3 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS2 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap6POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap6POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap6POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap6POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS4 = responsePOTS4 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS3 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap5POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap5POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap5POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap5POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS5 = responsePOTS5 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS4 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap4POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap4POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap4POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap4POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS6 = responsePOTS6 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS5 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap3POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap3POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap3POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap3POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS7 = responsePOTS7 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS6 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap2POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap2POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap2POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap2POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
var responsePOTS8 = responsePOTS8 || [];  // this variable is used for storing list items
 ...
 var sommePOTS=0;
  ...
  var urlPOTS7 = _spPageContextInfo.webAbsoluteUrl + "/_api/projectdata/[en-US]/Tasks?$select=DCT_POTS&$filter=TaskStartDate lt datetime'"+sSwap1POTS+"' and ProjectId eq guid'cacd4332-3db2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap1POTS+"' and ProjectId eq guid'aade112c-3fb2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap1POTS+"' and ProjectId eq guid'62598f36-41b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100 or TaskStartDate lt datetime'"+sSwap1POTS+"' and ProjectId eq guid'246a0f14-42b2-ea11-a129-b0fc36e2e03c' and TaskName eq 'Fin de Mise en place Shelter' and TaskPercentCompleted eq 100";
...
function RemplirTab()
{
  ...
  window.sSwap81 = moment("2020-02-17");
  sSwap81=moment(sSwap81).format("YYYY-MM-DD");


  document.getElementById('Firstdate1').innerHTML = sSwap81;
  ...
  document.getElementById('Firstdate1VDSLPOTS').innerHTML = sSwap8;
  document.getElementById('Seconddate2VDSLPOTS').innerHTML = sSwap7;
  document.getElementById('Thirddate3VDSLPOTS').innerHTML = sSwap6;
  document.getElementById('Fourdate4VDSLPOTS').innerHTML = sSwap5;
  document.getElementById('Fivedate5VDSLPOTS').innerHTML = sSwap4;
  document.getElementById('Sixdate6VDSLPOTS').innerHTML = sSwap3;
  document.getElementById('Sevendate7VDSLPOTS').innerHTML = sSwap2;
  document.getElementById('Heightdate8VDSLPOTS').innerHTML = sSwap1;

    document.getElementById('Firstdate1VDSLPOTSSWAP').innerHTML = sSwap8;
  document.getElementById('Seconddate2VDSLPOTSSWAP').innerHTML = sSwap7;
  document.getElementById('Thirddate3VDSLPOTSSWAP').innerHTML = sSwap6;
  document.getElementById('Fourdate4VDSLPOTSSWAP').innerHTML = sSwap5;
  document.getElementById('Fivedate5VDSLPOTSSWAP').innerHTML = sSwap4;
  document.getElementById('Sixdate6VDSLPOTSSWAP').innerHTML = sSwap3;
  document.getElementById('Sevendate7VDSLPOTSSWAP').innerHTML = sSwap2;
  document.getElementById('Heightdate8VDSLPOTSSWAP').innerHTML = sSwap1;
...
setTimeout(loadEvolutionParSemaine,19000);
...
function loadEvolutionParSemaineInverse()
{
  ...
  sSwap8=moment(sSwap8).format("YYYY-MM-DD");
          ...
          SWAPs0 = document.getElementById('VDSL1').innerHTML;
          SWAPs1 = document.getElementById('VDSL2').innerHTML;
          SWAPs2 = document.getElementById('VDSL3').innerHTML;
          SWAPs3 = document.getElementById('VDSL4').innerHTML;
          SWAPs4 = document.getElementById('VDSL5').innerHTML;
          SWAPs5 = document.getElementById('VDSL6').innerHTML;
          SWAPs6 = document.getElementById('VDSL7').innerHTML;
          SWAPs7 = document.getElementById('VDSL8').innerHTML;


          TirageFoMax = parseInt(document.getElementById('TirageFo').innerHTML);

          POTS1 = document.getElementById('POTS1').innerHTML;
          POTS2 = document.getElementById('POTS2').innerHTML;
          POTS3 = document.getElementById('POTS3').innerHTML;
          POTS4 = document.getElementById('POTS4').innerHTML;
          POTS5 = document.getElementById('POTS5').innerHTML;
          POTS6 = document.getElementById('POTS6').innerHTML;
          POTS7 = document.getElementById('POTS7').innerHTML;
          POTS8 = document.getElementById('POTS8').innerHTML;
...
setTimeout(loadEvolutionParSemaineInverse,32000);
                   ...
                   if((Identifiant == "cacd4332-3db2-ea11-a129-b0fc36e2e03c")||(Identifiant == "aade112c-3fb2-ea11-a129-b0fc36e2e03c")||(Identifiant == "62598f36-41b2-ea11-a129-b0fc36e2e03c")||(Identifiant == "246a0f14-42b2-ea11-a129-b0fc36e2e03c"))
                    ...
                    var actualfinishdateCompare = moment(actualFinishDate).format('YYYY-MM-DD');
                      ...
                      var percentComplete = value.TaskPercentCompleted;
                          ...
                          if(percentComplete !="100")
                          {
                            SurveyInOutTimes(Identifiant,idTask); 
                          }
                          else
                          {
...
function SurveyInOutTimes(Identifiant,idTask){
  
  window.nextWeekEnd = moment().day(0); 
 
   somSurvey=document.getElementById("SurveyPlan").innerHTML;
