  ...
  <head>
    ...
    <!-- Font Awesome -->
    <link href="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->

    <link href="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/css/custom1.min.css" rel="stylesheet">
...
a#ctl00_PageStateActionButton {
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>ISSUE COUNT BY OWNER > STATUS</h2>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>ISSUES COUNT BY PRIORITY > STATUS</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                  <div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>RISK COUNT BY OWNER > STATUS</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div>
    ...
    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/chart.js@2.8.0.js"></script>

    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/chartjs-plugin-datalabels@0.5.0"></script>

    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/chartjs-plugin-labels.js"></script>

    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/fastclick.js"></script>
    <!-- NProgress -->
    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/nprogress.js"></script>
    <!-- iCheck -->
    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/icheck.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/emn178/chartjs-plugin-labels/src/chartjs-plugin-labels.js"></script>
    <script src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/echarts.min.js"></script>
