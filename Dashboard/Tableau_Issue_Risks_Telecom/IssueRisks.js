<head>
    ...
    <!-- Bootstrap -->
    <link href="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/css/bootstrap.min.css"
        rel="stylesheet">
    <!-- Font Awesome -->
    <link href="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/css/font-awesome.min.css"
        rel="stylesheet">
    <!-- NProgress -->

    <link href="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/css/custom1.min.css"
        rel="stylesheet">
...
<div class="right_col" role="main">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="card">
                <h4>ISSUE COUNT BY OWNER > STATUS</h4>
                <div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="card">
                <h4>ISSUES COUNT BY PRIORITY > STATUS</h4>
                <div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="card">
                <h4>RISK COUNT BY OWNER > STATUS</h4>
                <div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
           <div class="col-md-12 col-sm-12 col-xs-12" style="padding-right: 0px; padding-left: 0px; padding-bottom: 66px">
            <div class="card">
                <h4>RISKS BY CATEGORY</h4>
                <div>
                ...
                <table id="tableaux1" class="table table-striped jambo_table bulk_action">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="column-title">OWNER </th>
                            <th class="column-title">DUE DATE </th>
                            <th class="column-title">PROBABILITY </th>
                            <th class="column-title">INPACT </th>
                            <th class="column-title">STATUS </th>
                            <th class="column-title" style="display:none">NomProjet </th>
                            <th class="column-title" style="display:none">Category </th>
                        </tr>
...
<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/chart.js@2.8.0.js"></script>

<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/chartjs-plugin-datalabels@0.5.0"></script>

<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/chartjs-plugin-labels.js"></script>

<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/jquery.min.js"></script>
<!-- Bootstrap -->
<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/bootstrap.min.js"></script>
<!-- FastClick -->
<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/fastclick.js"></script>
<!-- NProgress -->
<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/nprogress.js"></script>
<!-- iCheck -->
<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/icheck.min.js"></script>
<script src="https://cdn.jsdelivr.net/gh/emn178/chartjs-plugin-labels/src/chartjs-plugin-labels.js"></script>
<script
    src="/sites/PWAdemo/_catalogs/masterpage/Dashboard/Tableau_Issue_Risks_Telecom/javascript/echarts.min.js"></script>
...
<script type="text/javascript">
    ...
    function RiskMatrixFiltrer() {
        ...
        $.ajax({
            url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Risks?$filter=Status%20eq%20%27" + nomress + "%27",
    ...
    function LoadRisks() {
        $.ajax({
            url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Risks",
    ...
    function LoadIssues() {
        $.ajax({
            url: _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Issues",
