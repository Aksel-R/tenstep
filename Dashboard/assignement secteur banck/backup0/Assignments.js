...
#tableaux1 th {
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="card-box table-responsive">
                          ...
                          <table id="tableaux" class="table table-striped jambo_table table-bordered">
                            <thead>
                              <tr>
                                <th>Num</th>
    ...
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/chartjs-plugin-datalabels@0.5.0"></script>

    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/chartjs-plugin-labels.js"></script>
    ...
    <script src="/sites/Secteur_Bank/_catalogs/masterpage/Dashboard/Assignments/javascript/echarts.min.js"></script>
