...
<body>
    <div id="headercolor">
        ...
        <select style="color:black; font-weight:bold;" id="mylist" onchange="mainfilter();">
        ...
        <div class="col-sm-2" >
                    ...
                    <div class="card mb-3" style="width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:100px; background-color: #fafffa;">

    <div class="card-header">
    <div class="col-sm-4">
    <span class="card-widget__icon"><img src='/sites/PWAdemo/_catalogs/masterpage/Dashboard/Ressources_Projet/img/yesterday.png' class='img-rounded' alt='Cinque Terre' width='50px' height='50px'></span>
      </div>
    <div class="col"><h4 class="card-title">Glissement projet</h4>
   
</div>
      <div class="card-body">
     
          <p class="card-text" id="GlissementProjet" style="font-size: x-large; text-align: center;"></p></div>
   ...
   <div class="card-header">
    <div class="col-sm-4">
    <span class="card-widget__icon"><img src='/sites/PWAdemo/_catalogs/masterpage/Dashboard/Status_Projet/img/budget.png' class='img-rounded' alt='Cinque Terre' width='50px' height='50px'></span>
      </div>
    <div class="col"><h4 class="card-title">Coût projet</h4>
   
</div>
      <div class="card-body">
     
          <p class="card-text" id="CostProject" style="font-size: x-large; text-align: center;"></p></div>
   ...
   <div class="card-header">
    ...
    <div class="col-sm-4">
      <span class="card-widget__icon"><img src='/sites/PWAdemo/_catalogs/masterpage/Dashboard/Status_Projet/img/analytics2.png' class='img-rounded' alt='Cinque Terre' width='50px' height='50px'></span>
    </div>
    
    <div class="col"><h4 class="card-title">Coût variance</h4>
     
   
</div>
      <div class="card-body">
     
        <p class="card-text" id="CostVariance" style="font-size: x-large; text-align: center;"></p></div>
...
<div class="card mb-3" style="width: 100%;  box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:100px; background-color: #fafffa;">
   <div class="card-header">
    <div class="col-sm-4">
    <span class="card-widget__icon"><img src='/sites/PWAdemo/_catalogs/masterpage/Dashboard/Status_Projet/img/analytics.png' class='img-rounded' alt='Cinque Terre' width='50px' height='50px'></span>
      </div>
    <div class="col"><h4 class="card-title">Travail projet</h4>

</div>
      <div class="card-body">
     
     <p class="card-text"id="WorkProj" style="font-size: x-large; text-align: center;"></p>   </div>
...
<div class="card mb-3" style="width: 100%;  box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:100px; background-color: #fafffa;">
   <div class="card-header">
    ...
    <div class="col"><h4 class="card-title">Travail variance</h4>

</div>
      <div class="card-body">
     
     <p class="card-text"id="WorkVariance" style="font-size: x-large; text-align: center;"></p>   </div>
...
<div class="card mb-3" style="width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:100px; background-color: #fafffa;">
   <div class="card-header">
    <div class="col-sm-4">
    <span class="card-widget__icon"><img src='/sites/PWAdemo/_catalogs/masterpage/Dashboard/Status_Projet/img/risk.png' class='img-rounded' alt='Cinque Terre' width='50px' height='50px'></span>
      </div>
    <div class="col"><h4 class="card-title">Nombre risque</h4>
     
   
</div>
      <div class="card-body">
     
          <p class="card-text"id="RiskNumber" style="font-size: x-large; text-align: center;"></p></div>
...
<div class="card mb-3" style="width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:100px; background-color: #fafffa;">
   <div class="card-header">
    <div class="col-sm-4">
    <span class="card-widget__icon"><img src='/sites/PWAdemo/_catalogs/masterpage/Dashboard/Status_Projet/img/caution.png' class='img-rounded' alt='Cinque Terre' width='50px' height='50px'></span>
      </div>
    <div class="col"><h4 class="card-title">Nombre problème</h4>
   
   
    </div>
      <div class="card-body">
     
     <p class="card-text"id="ProblemNumber" style="font-size: x-large; text-align: center;"></p>  </div>
