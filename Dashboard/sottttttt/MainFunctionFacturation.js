...
/*        var MontantAttachementTVATabBefore;
        ...
        //console.log("identOpeTabFinal " + identOpeTabFinal.join());
...
function SaveAttachementOperation(identOpeTabFinal,TabAppelFinal,arrPrixUnitFinal,ReceptionAttTabFinal,ClientAttTabFinal,ProductOwner,tabOpFinal,DescriptionAtt,activiteAtt,RegionAtt,nomAttachementTabFinal,operationImpress,MontantAttachementTVATabBefore,MontantAttachementTTCTabBefore,TVAAttachementTabSaveBefore,TVAAttachementTabTVA){
  ...
  itemArray4 = ClientAttTabFinal;
        ...
        var oList = clientContext.get_web().get_lists().getByTitle("AttachementFacture");
            ...
            oListItem.set_item('TVA',TVAAttachementTabTVA);
...
if(tablePaginationArticleAtt.length>0)                     
                   ...
                   TabFinalResourcesToPrint(CodeArticleTab,libArticleTab,quantiteArticleTab,prixVenteTab,montantTotalTab,montantTTCTab,idArticleTab,unityTab,prixTVATAB);
...
function TabFinalResourcesToPrint(CodeArticleTab,libArticleTab,quantiteArticleTab,prixVenteTab,montantTotalTab,montantTTCTab,idArticleTab,unityTab,prixTVATAB)
{
   ...
   for(var i=0; i<identTab.length;i++)
            {
                var tr;  
                  tr = $("<tr class='rowAttachement' id='"+(tbodyRef.rows.length+ 1)+"'/>");
                        ...
                        tr.append("<td style='margin:auto;'><input id='my-attachments' type='file' fileread='run.AttachmentData' fileinfo='run.AttachmentInfo' /></td>");
                    $('#tableauxAttachement').append(tr);  
                    console.log("identTab  " + identTab[i]);
            }



                   /* $('#tableauxAttachement').on('change', '#my-attachments', function () {

                                var Ident= $(this).closest('tr').find('#glyphiconConsultPrix').val();
                                //var Ident = 149;
                                
                                loadAttachment(Ident);
                            });*/
...
function ShowContainer()
{
    ...
    var showForms =  "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control' onkeypress='return event.keyCode != 13;' required  id='codeEdit' placeholder='Code'/>"+
                                      ...
                                      "<div id='AttEdit' class='form-group'>"+
                                          ...
                                          "<input type='date' class='form-control' onkeypress='return event.keyCode != 13;' required  id='dateEdit' placeholder='Date'/>"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='number' class='form-control'onkeypress='return event.keyCode != 13;' min='1' required  id='nbClientEdit'  placeholder='Nombre client'/>"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control'onkeypress='return event.keyCode != 13;' required  id='clientEdit'  placeholder='Client'/>"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control'onkeypress='return event.keyCode != 13;' required  id='beneficierEdit'  placeholder='Bénéficier'/>"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control'onkeypress='return event.keyCode != 13;' required  id='utilisateurEdit'  placeholder='Utilisateur'/>"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control'onkeypress='return event.keyCode != 13;' required  id='factureEdit' placeholder='Facture' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='date' class='form-control'onkeypress='return event.keyCode != 13;' required  id='DateFactEdit' placeholder='DateFact' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control' onkeypress='return event.keyCode != 13;' required  id='AppelIdent' placeholder='Appel' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control' onkeypress='return event.keyCode != 13;' required  id='CroquisEdit' placeholder='Croquis' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='text' class='form-control' onkeypress='return event.keyCode != 13;' required  id='PATEdit' placeholder='PAT' />"+
                                          "<label class='control-label' id='PATEditErreur' style='color:red; display:none;'>Erreur ! Merci de remplir le champs</label>"+
                                      "</div>"+

                                      "<div class='form-group'>"+
                                          "<label for='text' class='control-label'>PV RP</label>"+
                                          "<input type='text' class='form-control' onkeypress='return event.keyCode != 13;' required  id='PVRepEdit' placeholder='PV de réception'/>"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='date' class='form-control'onkeypress='return event.keyCode != 13;' required  id='RDPrevuEdit' placeholder='RD Prévu' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='date' class='form-control' onkeypress='return event.keyCode != 13;' required  id='RPFactEdit' placeholder='Recep Prov fact' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<input type='date' class='form-control' onkeypress='return event.keyCode != 13;' required  id='RDFactEdit' placeholder='Recep def facture' />"+
                                      ...
                                      "<div class='form-group'>"+
                                          ...
                                          "<select class='form-control' id='Sous_TraitEdit' data-live-search='true' name='city' data-live-search='true'>"+
                                      ...
                                      "<div class='form-group'>"+
                                        "<label for='text' class='control-label'>Charge ST</label>"+
                                          "<input type='text' class='form-control'onkeypress='return event.keyCode != 13;' required  id='chargeSTEdit' placeholder='Sous_traitance' />"+
           ...
           $('#modifier').click(function(){
            ...
            tableaux = document.getElementById("tableauxAttachement");
              ...
              //var DateFactEdit =$("#DateFactEdit").val();
               ...
               Sous_TraitEdit =$("#Sous_TraitEdit").val();
...
$(document).ready(function() {
    $('#tableauxAttachement').on('click', '#glyphicon2', function () {
      ...
      jQuery('#loader-wrapper').fadeOut(3200);
        ...
        var TVA = $(this).closest('tr').find('#TVAAttachement').text();
        ...
        if(TVA != "")
        {
          ...
          document.getElementById("TVAPercent").innerHTML = TVA;
        }
        $(this).closest('tr').find('#TVAPercent').attr('disabled','disabled');
            ...
            if((quantite != "") ||(quantite !=0))
                {
                    ...
                    AddData(quantite,nomAttachement,nomOperation,idAttachementSave,idOperation,idAttachement,prixTVA,unity);
                    updateSum();
                }   
        }
    }    
                                ...
                                $(document).ready(function() {
                                    ...
                                    var test = $("#affArticle").val();
                                      ...
                                      else
                                      {
                                        ...
                                        var prix1 = parseFloat(prix * parseInt(quantite)).toFixed(3);

                                        var lePrixTVA = parseFloat(prix1 * (prixTVA/100)).toFixed(3);

                                        var prixTTCFinal = parseInt(prix1) * ((parseFloat(prixTVA).toFixed(2)/100)+1);
                                        ...
                                        LoadAllArticles(codeArticle,Article,prix,prix1,quantite,nomAttachement,nomOperation,idAttachementSave,idOperation,idAttachement,prixTTCFinal,unity,lePrixTVA);
...
function LoadAllArticleSaved(attachList,idOperation,idAttachement,Attacher)
{
  ...
  function LoadAllArticleSavedRegistring()
  {
    ...
    $.ajax({
                   ...
                   TabFinalResources(Attacher,idOperationTabList,idAModifierTab,CodeArticleTab,libArticleTab,quantiteArticleTab,prixVenteTab,montantTotalTab,sommePrixArticle,idAttachement,montantTTCTab,unityTab,MontantTVATab);
...
function TabFinalResources(Attacher,idOperationTabList,idAModifierTab,CodeArticleTab,libArticleTab,quantiteArticleTab,prixVenteTab,montantTotalTab,sommePrixArticle,idAttachement,montantTTCTab,unityTab,MontantTVATab)
{
            ...
            var tbodyRef = document.querySelector('#tableauxArticle tbody');
                ...
                var tr;  
                      tr = $("<tr class='rowTableauxArticles'/>");
                        ...
                        tr.append("<td id='prix1Art'>"+montantTotalTab[i]+"</td>");
                        tr.append("<td id='lePrixTVA'>"+MontantTVATab[i]+"</td>");
                        tr.append("<td id='montantTTC'>"+montantTTCTab[i]+"</td>");
...
function LoadAllArticles(codeArticle,Article,prix,prix1,quantite,nomAttachementArt,nomOperation,idAttachementSave,idOperation,idAttachement,prixTTCFinal,unity,lePrixTVA)
{
    ...
    var tbodyRef = document.querySelector('#tableauxArticle tbody');
        var tr;  
                  tr = $("<tr class='rowTableauxArticles'/>");
                    ...
                    tr.append("<td id='prix1Art'>"+prix1+"</td>");
                    tr.append("<td id='lePrixTVA'>"+lePrixTVA+"</td>");
...
$(document).ready(function() {
          $('#tableauxArticle').on('click', '#DisableTable', function() {
            ...
            $(this).closest('tr').find("#glyphicon3").attr('disabled','disabled');
                ...
                updatePrixAttachment(updateTasks,montant,prixTVA,montantTVAArticle,montantTTCArticle);
                ...
                InsertMultipleRowArticle(codeArticle1,Article1,prix1,quantite1,prix11,nomAttachement1,nomOperation1,idOperationSaveArt,idAttachementSaveArt,montantTTC,unity,lePrixTVA);
                //$(this).closest('tr').remove();
...
function updatePrixAttachment(updateTasks,montant,prixTVA,montantTVAArticle,montantTTCArticle)
{
...
function InsertMultipleRowArticle(codeArticle,Article,prix,quantite,prix1,nomAttachement,nomOperation,idOperationSaveArt,idAttachementSaveArt,montantTTC,unity,lePrixTVA)
{
  ...
  async: true,
   success: function(data){
      ...
      if(arrgrp.indexOf(grpComm)>-1)
        ...
        var grpServiceF="Service Financier";
