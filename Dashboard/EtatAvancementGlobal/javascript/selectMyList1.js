...
var axeStrategique1=document.getElementById("myList1").value;
  		if (axeStrategique1!="") {
        	urlFilter1Selected1+="&$filter=AxeStrategique%20eq%27"+axeStrategique1+"%27";
      	}else{
      		urlFilter1Selected1= "";
      		urlFilterSelected= "";
			countSelected=0;
	   ...
	   var responseRemplirSelectChantierFilter1=responseRemplirSelectChantierFilter1 || [];
        var urlRemplirSelectChantierFilter1= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Structuresimpliquees,Chantier"+urlFilter1Selected1;
        ...
        var urlRemplirSelectProjectFilter1= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Structuresimpliquees,ProjectName"+urlFilter1Selected1;
        ...
        var urlRemplirSelectSponsorFilter1= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Structuresimpliquees,Sponsor"+urlFilter1Selected1;
        ...
        var urlRemplirSelectCpFilter1= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Structuresimpliquees,ProjectOwnerName"+urlFilter1Selected1;
        ...
        var urlRemplirSelectMethFilter1= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Typedegestion"+urlFilter1Selected1;
        ...
        var urlRemplirSelectStructFilter1= _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Structuresimpliquees"+urlFilter1Selected1;
