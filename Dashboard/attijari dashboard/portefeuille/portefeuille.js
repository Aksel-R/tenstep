...
<div id="loader-wrapper" style="display:none">
    ...
    <!-- Navigation -->
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
                ...
                <select style="float: right; width: 100%; background-color: #fceac5; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList1" onchange="filterPortefeuille();">
    ...
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/filterPortefolio.js"></script> 
