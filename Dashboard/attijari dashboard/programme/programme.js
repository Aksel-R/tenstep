...
<div id="loader-wrapper" style="display:none">
    ...
    <!-- Navigation -->
                    ...
                    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <select disabled="" style="float: right; width: 100%; background-color: #fceac5; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList2" onchange="mainfilter();">
            ...
            <div class="row" id="row0">
                <div class="col-md-4 col-xs-12" style="padding-right: 5px;">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-clock-o fa-2x"></i> Charge de travail du programme
                            </h3>
                        </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-2x"></i> Coût du programme
                            </h3>
                        </div>
                        <div class="panel-body" style="padding: 0px 15px;">
                            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-calendar-times-o fa-2x"></i> Durée du programme
                            </h3>
                        </div>
                        <div class="panel-body" style="padding: 0px 15px;">
                            <div class="row">
                ...
                <div class="col-md-8 col-xs-12" style="padding-left: 5px;">
                    <div class="col-sm-12" style=" padding-left: 0px; padding-right: 0px;">
                        <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title" style="text-align: center;"><i class="fa fa-percent fa-2x"></i> Pourcentage achevé des projets
                                    </h3>
                                </div>
                                <div class="panel-body" style="padding: 0px 15px;">
                                    <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12 form-group" style="    float: right;">
                               ...
                               <table class="table  table-hover table-striped" style=" margin-bottom: 0px; border-radius: 7px 7px 0px 0px;"id="tableProjet11">
                                    <thead style="background-image: linear-gradient(225deg, #fceac5 20%, #f18572 80%);color: black; ">
                                            <tr>
                                                <th style="text-align:center;width: 50%;cursor: pointer;">Intitulé des projets</th>
    ...
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/filterProgramme.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_SDSI/javascript/progsel1.js"></script>
...
//    css_html = css_html.replace(/ /g, '%20');
    ...
    a.download = 'Pourcentage achevé des projets' + postfix + '.xls';
