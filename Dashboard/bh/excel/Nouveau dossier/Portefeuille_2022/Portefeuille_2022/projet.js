...
<div id="loader-wrapper" style="display:none">
    ...
    <!-- Navigation -->
                    ...
                    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
                        ...
                        <div class="col-md-3 col-xs-12"  style="padding-left: 5px;padding-right: 5px;">
                            <select disabled style="float: right; width: 100%; background-color: white; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;"
    ...
    <!-- /#wrapper -->
    <script  src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/filterProjet.js"></script>
    <script  src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/projsel1.js"></script>
    <script  src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/projsel2.js"></script>
