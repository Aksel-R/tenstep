...
<div id="loader-wrapper" style="display:none">
    ...
    <!-- Navigation -->
                    ...
                    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <select disabled="" style="float: right; width: 100%; background-color: white; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList2" onchange="mainfilter();">
    ...
    <script  src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/filterProgramme.js"></script>
    <script  src="/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/javascript/progsel1.js"></script>
