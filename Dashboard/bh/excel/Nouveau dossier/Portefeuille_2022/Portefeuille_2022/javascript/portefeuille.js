...
<head>
    ...
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/bootstrap.min.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/bootstrap.css"  rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/style.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/achevement.css"  rel="stylesheet">
    <link  href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/dataTables.bootstrap4.min.css"  rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/w3.css" rel="stylesheet">
    <link href="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/css/jquery.dataTables.min.css" rel="stylesheet">
...
<div id="loader-wrapper" style="display:none">
    ...
    <!-- Navigation -->
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="border-radius: 5px;margin-bottom: 0px;">
                ...
                <select style="float: right; width: 100%; background-color: #fceac5; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList1" onchange="selectMyList1111();filterPortefeuille();">
                                <option value="" selected disabled>Portefeuille</option>

                            </select>
            </div>
            <div class="col-md-3 col-xs-12">
                            <select disabled="" style="float: right; width: 100%; background-color: #fceac5; color: #607d8b; font-size: 20px; border-radius: 5px ;  border-color: azure;" id="myList3" onchange="filterPortefeuille();">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-3 col-xs-12" style="padding: 10px 5px 10px 15px;">
            ...
            <div class="col-md-3 col-xs-12" style="padding: 10px 5px 10px 5px;">
                <div class="rounded-lg p-3 shadow" style=" background-color: #f18572;">
                <div class="row">
                    <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
              ...
              <div class="col-md-3 col-xs-12" style="padding: 10px 5px 10px 5px;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                                            <i class="fa fa-money fa-2x"></i> Budget Planifié:</h2></div>
                                        <!-- Demo info -->
                                        <div class="col-lg-4"><div class="row text-center mt-2" style=" margin-top: 0px;">
                                            <div class="col-12">
                                                <div class="h3 font-weight-bold mb-0" style=" margin-top: 0px;" id="cashIn"></div>
                                            </div>
                                        </div></div><!-- END -->
                                    </div></div>
                                </div>
                                <div class="col-md-3 col-xs-12" style="padding: 10px 15px 10px 5px;">
                                    <div class="rounded-lg p-3 shadow" style=" background-color: #f18572;">
                                    <div class="row">
                                        <div class="col-lg-8"><h2 class="h5 font-weight-bold text-center mb-2" style="margin-top: 0px;float: left;">
                                            <i class="fa fa-money fa-2x"></i> Budget Consommé:</h2></div>
                                        <!-- Demo info -->
                                        <div class="col-lg-4"><div class="row text-center mt-2" style=" margin-top: 0px;">
                                            <div class="col-12">
                                                <div class="h3 font-weight-bold mb-0" style=" margin-top: 0px;" id="cashOut"></div>
                                            </div>
                                        </div></div><!-- END -->
                                    </div></div>
                                </div>
            ...
            <div class="row" id="row0">
                ...
                <div class="col-md-8 col-xs-12" style="padding-left: 5px;">
                    <div class="col-sm-12" style=" padding-left: 0px; padding-right: 0px;">
                      ...
                      <div class="col-sm-12" style=" padding-left: 0px; padding-right: 0px;">
                            <div class="panel-heading" style="padding: 0px;">
                               <table class="table  table-hover table-striped" style=" margin-bottom: 0px; border-radius: 7px 7px 0px 0px;">
                                    <thead style="background-image: linear-gradient(225deg, #fceac5 20%, #f18572 80%);color: black; ">
                                            <tr>
                                                <th style="text-align:center;width: 50%;">Intitulé des programmes</th>
                                                <th style="text-align:center;width: 50%;">% achevé </th>
                                            </tr>
                                    </thead>
                                </table>
                    ...
                    <div class="col-md-12 col-xs-12">
                            ...
                            <button type="button" id="btnExport" title="Exporter vers excel"><img src='/sites/pwa/_catalogs/masterpage/Portefeuille_2022/img/Excel.png' class='img-rounded' alt='Cinque Terre' width='25px' height='25px'> Exporter vers excel</button>
                        </div>
                    <div class="col-sm-12" style=" padding-left: 0px; padding-right: 0px;display:none">
                            <div class="panel-heading" style="padding: 0px;">
                               
                                <div class="tableFixHead" style="overflow-y:auto;height: 215px">
                                    <table class="table table-bordered table-hover table-striped"
                                        style="border-radius:7px" id="tableProjet">
                                        <thead
                                            style="background-image: linear-gradient(225deg, #fceac5 20%, #f18572 80%);color: black; ">
                                            <tr>
                                                <th style="text-align:center;">Intitulé des programmes</th>
                                                <th style="text-align:center;">% achevé (Pondéré)</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                    </table>
    ...
    <!-- /#wrapper -->
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/javascript/jquery3.4.1.js"></script>
    <script  src="https://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/javascript/Chart.min.js"></script>
   <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/javascript/filterPortefolio.js"></script> 
    <script  src="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/javascript/typeSelPortefeuille.js"></script>

    <script src="/sites/pwa/_catalogs/masterpage/Portefeuille_2022/javascript/moment-with-locales.min.js"></script>
    ...
    $.ajax({
                  ...
                  success: function (data) {
                      ...
                      $.each(responseSelectPortefeuille, function (key, value) {
                         if (value.EnterpriseProjectTypeName!=null && value.EnterpriseProjectTypeName == "Portefeuille (2022)" ) {
