...
function filterPortefeuille(){
  ...
  var typePrjt=getSelectedText("myList3");
      ...
      if (Tproj!="") {
        urlFilterPortefeuille+=" and Types_des_projets eq%27"+typePrjt+"%27";
      }
            ...
            success: function (data) {
                ...
                if ((arrSat[arrId.indexOf(projId)]=="Clôturé")&&(arrAch[arrId.indexOf(projId)]==100)&&(moment(arrBaseFinish[arrId.indexOf(projId)]).isBefore(moment(auj)))) {
                  var tr1;
                   ...
                   tr1.append("<td style='text-align:center;width: 20%; text-align: left;'><a href='https://m365x56447071.sharepoint.com/sites/Secteur_Bank/project%20detail%20pages/schedule.aspx?projuid="+projId+"&ret=0' id='redirectLink' target='_blank'><img src='/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/img/Link.png' class='img-rounded' alt='Cinque Terre' width='25px' height='25px'></a></td>");
                 ...
                 if (moment(arrBaseFinish[arrId.indexOf(projId)]).isBefore(moment(auj))) {
                  ...
                  var tr2;
                   ...
                   tr2.append("<td style='text-align:center;width: 20%; text-align: left;'><a href='https://m365x56447071.sharepoint.com/sites/Secteur_Bank/project%20detail%20pages/schedule.aspx?projuid="+projId+"&ret=0' id='redirectLink' target='_blank'><img src='/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/img/Link.png' class='img-rounded' alt='Cinque Terre' width='25px' height='25px'></a></td>");
                 ...
                 if ((arrSat[arrId.indexOf(projId)]!="Clôturé")&&(moment(arrBaseFinish[arrId.indexOf(projId)]).isBefore(moment(auj)))&&(arrAch[arrId.indexOf(projId)]<100)){
                   ...
                   tr3.append("<td style='text-align:center;width: 20%; text-align: left;'><a href='https://m365x56447071.sharepoint.com/sites/Secteur_Bank/project%20detail%20pages/schedule.aspx?projuid="+projId+"&ret=0' id='redirectLink' target='_blank'><img src='/sites/Secteur_Bank/_catalogs/masterpage/Portefeuille_2022/img/Link.png' class='img-rounded' alt='Cinque Terre' width='25px' height='25px'></a></td>");
                ...
                //console.log("trez1.length= "+trez1.length);
                document.getElementById("nbProjlivDate").innerHTML = parseInt(trez1.length-1) +' <span class="text-gray">Projets</span>';
