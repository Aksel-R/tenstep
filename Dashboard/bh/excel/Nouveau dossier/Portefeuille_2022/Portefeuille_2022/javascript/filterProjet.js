  ...
  function loadKPIs(){
       $.ajax({
          ...
          success: function (data) {
              ...
              var variationduree=0;
              var phaseADate="";
              var statutPProj="";
              $.each(responseKPIs, function (key, value) {
                phaseADate=value.Phaseàdate;
                statutPProj=value.Statutduprojet;
                dureeReel=parseFloat(value.ProjectActualDuration/8).toFixed(0);
                ...
                var coutReel=parseFloat(value.ProjectActualCost);
                 ...
                 variationduree=parseFloat(value.ProjectDurationVariance/8);
              ...
              document.getElementById("dureeglissprog").innerHTML = conToMill(parseFloat(variationduree).toFixed(0))+' <span class="text-gray">J</span>';
              document.getElementById("phaseProj").innerHTML = phaseADate;
              document.getElementById("statProj").innerHTML = statutPProj;
              var glissEch=0;
                if (finReelProg!= null) {
