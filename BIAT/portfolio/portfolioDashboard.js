  ...
  <head>
    ...
    <!-- NProgress -->
    <link href="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/css/custom1.min.css" rel="stylesheet">
...
<div id="overlay">
        ...
        <div class="col-lg-8 col-xs-12">
          ...
          <div class="col-lg-2 col-xs-12">
            <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist2"
                onchange="loadSelectStuct();filtrePortefeuille();">
                <option value="">PORTEFEUILLE PROJET</option>
            </select>
          </div>
          <div class="col-lg-2 col-xs-12">
             <select class="mdb-select md-form" style="color:black; font-weight:bold;" id="mylist1"
                onchange="filtrePortefeuille();" disabled>
                <option value="">STRUCTURE ORGANISATIONNELLE</option>
            </select>
          </div>
        </div>
    </div>
    <div class="row">
      <div class="col-lg-2 col-xs-12" >
        <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon">
                    <img src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/e-learning.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Nombre de portefeuilles</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                ...
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Nombre des Structures organisationnelles</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #c9dcc9;">
            <div class="card-header">
                ...
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Nombre de projets</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display:none;">
            <div class="card-header">
                <div class="col-sm-3" style="padding-top: 10px">
                    <span class="card-widget__icon"><img
                            src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/calculator.png'
                            class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                </div>
                <div class="col">
                    <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Coût</h6>
                </div>
                <div class="card-body">
        ...
        <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display:none;">
                <div class="card-header">
                    ...
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Coût consommée</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display:none;">
                <div class="card-header">
                    ...
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Coût restant</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;display:none;">
                <div class="card-header">
                    <div class="col-sm-3" style="padding-top: 10px">
                        <span class="card-widget__icon"><img
                                src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/budget.png'
                                class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                    </div>
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Variance de coût</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
                <div class="card-header">
                    <div class="col-sm-3" style="padding-top: 10px">
                        <span class="card-widget__icon"><img
                                src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/work.png'
                                class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                    </div>
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Travail</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
                <div class="card-header">
                    <div class="col-sm-3" style="padding-top: 10px">
                        <span class="card-widget__icon"><img
                                src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/watch.png'
                                class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                    </div>
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Variance de travail</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 100%;  box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
                <div class="card-header">
                    <div class="col-sm-3" style="padding-top: 10px">
                        <span class="card-widget__icon"><img
                                src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/risk.png'
                                class='img-rounded' alt='Cinque Terre' width='45px' height='45px'></span>
                    </div>
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Risques</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 100%; box-shadow: 0px 4px 8px 0px rgba(0, 0, 0, 0.5); min-height:80px; border-radius: 5px; background-color: #fafffa;">
                <div class="card-header">
                    <div class="col-sm-3" style="padding-top: 10px">
                        <span class="card-widget__icon"><img
                                src='/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/img/project.png' class='img-rounded'
                                alt='Cinque Terre' width='45px' height='45px'></span>
                    </div>
                    <div class="col">
                        <h6 class="card-title" style="color: black;text-align: center;padding-top: 10px;font-size: 100%;font-weight: bold;">Problèmes</h6>
                    </div>
                    <div class="card-body">
      ...
      <div class="col-lg-10 col-xs-12">
        <div class="col-sm-12">
                  <div class="x_panel" id="xpanelmodified"
                      style="width:100%; box-shadow: 0px 4px 8px 0px rgb(0 0 0 / 50%);border-radius: 5px;margin-top: 15px;">
                      <div class="x_title">
                       <h4 style="color: black;margin: 0px;"><b>% Achèvement</b></h4>
                          <div class="clearfix"></div>
                      </div>
                      <div id="projchartDiv">
                       <canvas id="projchart" style="max-height: 550px;display: block;width: 98%;"></canvas>
                      </div>
                  </div>
            </div>
            ...
            <div class="col-lg-6 col-xs-12">
             ...
             <div class="col-lg-6 col-xs-12">
                    <div class="x_panel" style="width:100%; box-shadow: 0px 4px 8px 0px rgb(0 0 0 / 50%);border-radius: 5px;">
                        <div class="x_title">
                            <h4  style="color: black;margin: 0px;" id="structAff"><b>NOMBRE DES PROJETS PAR STRUCTURE ORGANISATIONNELLE</b></h4>
                    ...
                    <table class="table table-striped  jambo_table bulk_action no-footer-border" id="tableaux">
                        <thead>
                            <tr>
                                                ...
                                                <th></th>
                                                <th style="width: 15%;">PORTEFEUILLE</th>
                                                <th style="width: 15%;">STRUCTURE ORGANISATIONNELLE</th>
    ...
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/jquery3.4.1.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/custom.min.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/Chart.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/emn178/chartjs-plugin-labels/src/chartjs-plugin-labels.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/nprogress.js"></script>
    
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/PortefeuilleFiltre.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/ProgrammeSelect.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/ProgrammeFiltre.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/ProprietaireProjetSelect.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/ProprietaireProjetFiltre.js"></script>
    <script src="/sites/pwa/_catalogs/masterpage/Dashboard/portFolioDashboard/javascript/MainFilter.js"></script>
...
function loadMain(){
        ...
        var urlNumberOfProjects = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectName,Structureorganisationnelle,EnterpriseProjectTypeName,TypePortefeuilleProgrammeProjet";
        console.log('urlNumberOfProjects= '+urlNumberOfProjects);
        ...
        var urlDataSum = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectCost,ProjectActualCost,ProjectCostVariance,ProjectWork,ProjectWorkVariance&$filter=TypePortefeuilleProgrammeProjet%20eq%27Portefeuille%27";
        ...
        var urlGovernancePhase = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=EnterpriseProjectTypeName,ProjectPercentCompleted,ProjectName&$filter=TypePortefeuilleProgrammeProjet%20eq%27Portefeuille%27"
        console.log('urlGovernancePhase= '+urlGovernancePhase);
        ...
        var urlPhaseChart = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=EnterpriseProjectTypeName&$filter=TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        console.log('urlPhaseChart= '+urlPhaseChart);
        ...
        var urlSous_Portefeuille = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=Structureorganisationnelle&$filter=TypePortefeuilleProgrammeProjet%20eq%27Projet%27";
        console.log('urlSous_Portefeuille= '+urlSous_Portefeuille);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(response_SousPortefeuille, function (key, value) {
                        ...
                        var epn = value.Structureorganisationnelle;
                        var som = 0;
                        if (epn != null) {
        ...
        var urlTabProj = _spPageContextInfo.siteAbsoluteUrl + "/_api/ProjectData/[en-US]/Projects?$select=ProjectWorkspaceInternalUrl,ProjectOwnerName,EnterpriseProjectTypeName,Structureorganisationnelle,TypePortefeuilleProgrammeProjet,ProjectId,ProjectDuration,ProjectName,ProjectStartDate,ProjectFinishDate,ProjectPercentCompleted,ProjectActualCost,ProjectActualWork,ProjectWorkVariance,ProjectWork,ProjectCost&$filter=TypePortefeuilleProgrammeProjet eq 'Projet'";
